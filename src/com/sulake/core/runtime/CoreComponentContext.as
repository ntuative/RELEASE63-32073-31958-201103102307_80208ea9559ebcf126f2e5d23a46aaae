package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1279:String = "asset-libraries";
      
      private static const const_1280:String = "library";
      
      private static const const_1283:String = "service-libraries";
      
      private static const const_1282:String = "library";
      
      private static const const_1285:String = "component-libraries";
      
      private static const const_1277:String = "library";
      
      private static const const_1284:String = "error_data";
      
      private static const const_1281:String = "error_cat";
      
      private static const const_1278:String = "error_desc";
      ...
      private var var_343:Function;
      
      private var var_192:Profiler;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_450.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1050:
               debug("Core; using simple frame update handler");
               this.var_343 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_773:
               debug("Core; using complex frame update handler");
               this.var_343 = this.complexFrameUpdateHandler;
               break;
            case Core.const_872:
               debug("Core; using profiler frame update handler");
               this.var_343 = this.profilerFrameUpdateHandler;
               this.var_192 = new Profiler(this);
               attachComponent(this.var_192,[new IIDProfiler()]);
               var_450.addChild(new ProfilerViewer(this.var_192));
               break;
            case Core.const_434:
               debug("Core; using experimental frame update handler");
               this.var_343 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_343 = this.debugFrameUpdateHandler;
         }
      }
      ...
      {
         return this.var_469 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            var_450.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
            var_450 = null;
            _loc3_ = 0;
            while(_loc3_ < CoreComponentContext.const_103)
            {
               _loc2_ = this.var_246[_loc3_] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         ...
         ErrorReportStorage.setParameter(const_1281,String(param3));
         ErrorReportStorage.setParameter(const_1278,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         try
         {
            node = config.child(const_1279)[0];
            if(node != null)
            {
               list = node.child(const_1280);
         ...
         try
         {
            node = config.child(const_1283)[0];
            if(node != null)
            {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1472);
         if(!disposed)
         {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_706)
                  {
                     this.var_706.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_469 - this.var_342.length,this.var_469,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_192 ? 0 : this.var_1333 & 0;
         if(_loc3_ == Core.const_434)
         {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_343(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var msCurrentTime:uint = param1;
         var msSinceLastUpdate:uint = param2;
         var maxTimePerFrame:uint = 1000 / var_450.stage.frameRate;
         priority = 0;
         while(priority < CoreComponentContext.const_103)
         {
            t = getTimer();
            ...
            {
               if(this.var_573[priority] < priority)
               {
                  ++this.var_573[priority];
                  skip = true;
               }
            }
            if(!skip)
         ...
         while(priority < CoreComponentContext.const_103)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_192.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
      ...
      public function setProfilerMode(param1:Boolean) : void
      {
         ...
         else
         {
            if(this.var_192)
            {
               detachComponent(this.var_192);
               this.var_192.dispose();
               this.var_192 = null;
            }
            switch(this.var_1333 & 0)
            {
               case Core.const_1050:
                  this.var_343 = this.simpleFrameUpdateHandler;
                  break;
