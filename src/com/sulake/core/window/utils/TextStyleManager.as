package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_184:String = "regular";
      ...
      private static var var_479:Array;
      ...
      private static const const_1301:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_86[const_184],var_86[ITALIC],var_86[BOLD]];
            var_86.reset();
            var_86[const_184] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_479.indexOf(_loc4_.name) == -1)
            {
               var_479.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_598);
         if(countSubStrings(param1,const_597) != countSubStrings(param1,const_598))
         {
            throw new Error("Mismatching amount of \"" + const_597 + "\" versus \"" + const_598 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1302) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1301) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_597)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
