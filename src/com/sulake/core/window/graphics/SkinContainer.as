package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_981:uint = 8;
      
      private static const const_1366:String = "skin";
      
      private static const const_1363:String = "bitmap";
      
      private static const const_1362:String = "fill";
      
      private static const const_1364:String = "text";
      
      private static const const_1365:String = "label";
      
      private static const const_1367:String = "shape";
      ...
      private var var_2693:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1897,this.var_2694);
         this.var_2692 = new Dictionary();
         this.var_2693 = new Dictionary();
         StateCodeTable.fillTables(this.var_2692,this.var_2693);
         this.var_434 = new Dictionary();
         this.var_434[const_1366] = BitmapSkinRenderer;
         this.var_434[const_1363] = BitmapDataRenderer;
         this.var_434[const_1362] = FillSkinRenderer;
         this.var_434[const_1364] = TextSkinRenderer;
         this.var_434[const_1365] = LabelRenderer;
         this.var_434[const_1367] = ShapeSkinRenderer;
         this.var_434[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_434[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_326 == null)
         {
            var_326 = new Array();
            var_326.push(WindowState.const_67);
            var_326.push(WindowState.const_84);
            var_326.push(WindowState.const_96);
            var_326.push(WindowState.const_56);
            var_326.push(WindowState.const_97);
            var_326.push(WindowState.const_82);
            var_326.push(WindowState.const_108);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1897[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_975[param1] == null)
         {
            this.var_975[param1] = new Array(const_981);
         }
         this.var_975[param1][param2] = param3;
         if(this.var_976[param1] == null)
         {
            this.var_976[param1] = new Array(const_981);
         }
         this.var_976[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_975[param1];
         if(_loc3_)
         {
