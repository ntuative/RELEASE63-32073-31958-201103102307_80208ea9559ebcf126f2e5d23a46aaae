package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_808:Dictionary;
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               _loc2_ = this.var_808[_loc1_] as BitmapData;
               _loc2_.dispose();
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_294)
                  {
                     var_33.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_443)
                  {
                     _loc12_ = true;
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_294)
                  {
                     var_33.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_443)
                  {
                     _loc13_ = true;
                  ...
                  {
                     this.var_821.a = 0 / _loc17_.width;
                     this.var_821.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_33.width,var_33.height,false);
                     _loc30_.draw(_loc17_,this.var_821);
                     _loc31_ = new BitmapData(var_33.width,var_33.height,true,0);
                     _loc31_.draw(_loc18_,this.var_821,null);
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_808[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
