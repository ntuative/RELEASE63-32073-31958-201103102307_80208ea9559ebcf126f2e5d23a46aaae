package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_387:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinTemplate(this.var_387[_loc1_]).dispose();
      ...
      {
         var _loc3_:ISkinTemplate = this.var_387[param2];
         if(_loc3_ == null)
         {
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_387[param1.name];
         if(param1 != null)
         {
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_387[param1.name];
         }
         return param1;
      }
   }
