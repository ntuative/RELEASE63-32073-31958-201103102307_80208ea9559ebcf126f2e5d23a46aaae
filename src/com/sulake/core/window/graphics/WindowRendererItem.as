package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_951:uint = 1;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1401 = 4294967295;
         this.var_914 = 0;
         this.var_1780 = new ColorTransform();
         this.var_1007 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_950) : uint(const_599);
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_951)
               {
                  ...
                  if(this.var_603)
                  {
                     ...
                     _loc7_.draw(param1,this.var_101,this.var_101.rect,this.var_914,false);
                  ...
                  {
                     this.var_1007.tx = param2.x;
                     this.var_1007.ty = param2.y;
                     this.var_1780.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_101,this.var_1007,this.var_1780,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = this.var_915.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_202)
            {
               _loc2_ = this.var_915.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_202);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_915.getTheActualState(param1.type,param1.style,param1.state) != this.var_1401;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_581:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1033:
               this.var_914 = this.var_915.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_914 != this.var_1401)
               {
                  this.var_603 = true;
                  _loc4_ = true;
               }
