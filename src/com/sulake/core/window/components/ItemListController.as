package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2009:Boolean = false;
      
      protected var var_536:Boolean = false;
      
      protected var _spacing:int = 0;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_2834:Number = 0.0;
      
      protected var var_2833:Number = 0.0;
      
      protected var var_1005:Boolean = true;
      
      protected var var_449:Boolean = false;
      
      protected var var_1250:Boolean = false;
      
      protected var var_2008:int = 0;
      
      protected var var_2007:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_170 = var_454 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_368,WindowStyle.const_866,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this.resizeOnItemUpdate = this.var_1250;
      }
      ...
      {
         return new Rectangle(this.var_656 * this.maxScrollH,this.var_657 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_656)
         {
            ...
            dispatchEvent(new WindowEvent(WindowEvent.const_522,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_657 = param1;
            this._container.y = -this.var_657 * this.maxScrollV;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_69);
            dispatchEvent(new WindowEvent(WindowEvent.const_522,this,null));
         }
      }
      ...
      {
         this.var_2834 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_463,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_520,param1);
            }
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_185:
               if(this.var_1249)
               {
                  this.var_1248 = this.var_2008 - _loc3_;
                  this.var_1251 = this.var_2007 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1251 != 0 && this.var_94 != 0)
                  {
                     this.scrollV += this.var_1251 / this.var_94;
                  }
                  this.var_2008 = _loc3_;
                  this.var_2007 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_203:
               if(this.var_1249)
               {
                  ...
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1251);
                  }
                  this.var_1249 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1005 && !this.var_536 && this._container)
         {
            this.var_536 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_721)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_395,this._spacing,PropertyStruct.const_41,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1041);
         }
         if(this.var_1005 != PropertyDefaults.const_1081)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_650,this.var_1005,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1510);
         }
         if(this.var_449 != PropertyDefaults.const_995)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_704,this.var_449,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1504);
         }
         if(this.var_1250 != PropertyDefaults.const_1078)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_680,this.var_1250,PropertyStruct.const_38,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_680:
                  ...
                  break;
               case PropertyDefaults.const_650:
                  this.var_1005 = _loc2_.value as Boolean;
                  break;
            }
         }
