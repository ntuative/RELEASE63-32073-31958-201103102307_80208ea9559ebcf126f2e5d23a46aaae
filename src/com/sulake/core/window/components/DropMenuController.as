package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_442,this,null,true);
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_177 == null || this.var_177.disposed)
         {
            this.var_177 = context.create(name + "::submenu","",WindowType.const_562,var_84,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_886 = false;
            this.getTitleLabel().text = this.var_587 < this.var_250.length && this.var_587 > -1 ? this.var_250[this.var_587] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         {
            _loc4_.getListItemAt(this.var_587).setStateFlag(WindowState.const_56,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_479)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1030:
            case WindowMouseEvent.const_59:
               ...
               break;
            case WindowTouchEvent.const_694:
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_250.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_735,this.var_250,PropertyStruct.const_151,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1445);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_735)
            {
