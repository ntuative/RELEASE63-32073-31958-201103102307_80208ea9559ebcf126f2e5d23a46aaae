package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1245:String = "_TITLE";
      ...
      private var var_1441:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1245) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1441 = findChildByTag(const_1352) as IHeaderWindow;
            if(!this.var_1441)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_172 = findChildByTag(const_1351) as IWindowContainer;
            if(!this.var_172)
            {
      ...
      {
         return this.content != null && this.var_1002 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_257);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_232,_loc3_.left,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_239,_loc3_.top,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_221,0 - _loc3_.right,PropertyStruct.const_41,_loc2_));
