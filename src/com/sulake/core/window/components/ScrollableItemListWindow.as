package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1166:IItemListWindow;
      
      private var var_418:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_418)
         {
            this.var_418.removeEventListener(WindowEvent.const_316,this.scrollBarEventProc);
            this.var_418.removeEventListener(WindowEvent.const_254,this.scrollBarEventProc);
            this.var_418 = null;
         }
         if(this.var_1166)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1166)
         {
            this.var_1166 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_418)
         {
            this.var_418 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_418)
            {
               this.var_418.addEventListener(WindowEvent.const_316,this.scrollBarEventProc);
               this.var_418.addEventListener(WindowEvent.const_254,this.scrollBarEventProc);
            }
         }
         return this.var_418;
      }
