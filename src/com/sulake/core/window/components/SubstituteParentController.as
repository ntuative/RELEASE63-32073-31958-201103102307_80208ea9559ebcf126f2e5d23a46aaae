package com.sulake.core.window.components
{
   ...
   public class SubstituteParentController extends WindowController
   {
      ...
      private function method_2(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_.removeEventListener(WindowEvent.const_110,this.method_2);
         }
      ...
      override public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         _loc3_.addEventListener(WindowEvent.const_110,this.method_2);
         return param1;
      }
      ...
      override public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            param1.removeEventListener(WindowEvent.const_110,this.method_2);
            param1.parent = null;
            return param1;
         }
         return null;
