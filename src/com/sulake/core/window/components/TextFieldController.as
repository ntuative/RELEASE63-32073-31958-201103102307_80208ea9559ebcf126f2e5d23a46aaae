package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1514:uint = 500;
      
      protected var var_1259:String = "";
      
      protected var var_1255:Boolean = false;
      ...
      {
         this.var_1259 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1129,var_11);
         }
         return var_22;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_479)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_689 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_366,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_676,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1451);
         _loc1_.push(this.var_1255 != PropertyDefaults.const_1107 ? new PropertyStruct(PropertyDefaults.const_787,this.var_1255,PropertyStruct.const_38,true) : PropertyDefaults.const_1617);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1075 ? new PropertyStruct(PropertyDefaults.const_724,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1644);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1145 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1670);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_787:
                  this.var_1255 = _loc2_.value as Boolean;
                  if(this.var_1255)
                  {
