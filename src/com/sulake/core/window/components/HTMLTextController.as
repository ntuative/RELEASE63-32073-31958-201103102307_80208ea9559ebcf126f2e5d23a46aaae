package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_844:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_845:String = "HabboRoomWidgetLib_pet_view";
      
      private var var_1057:String = null;
      
      private var var_1603:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1057 == param2)
         {
            return;
         }
         param1.var_1057 = param2;
         param1.var_1603 = null;
         if(param1.var_1057 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1057);
            param1.var_1603 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_668.indexOf(param1) > -1)
         {
            this.var_845 = param1;
         }
      }
      ...
      {
         return this.var_845 == LinkTarget.const_32 ? defaultLinkTarget : this.var_845;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1603;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_777)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_769,this.var_845,PropertyStruct.const_55,true,PropertyDefaults.const_668));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_769)
            {
