package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1369:String = "_SELECTOR";
      
      private static const const_1370:String = "_CONTENT";
       
      
      protected var var_1011:ITabSelectorWindow;
      
      protected var var_2022:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1011 = findChildByTag(const_1369) as ITabSelectorWindow;
            if(this.var_1011 != null)
            {
               this.var_1011.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2022 = findChildByTag(const_1370) as IWindowContainer;
         }
      ...
      {
         return !!this.var_689 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1011.numSelectables;
      }
