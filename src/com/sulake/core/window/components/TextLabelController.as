package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_327:Object = null;
      ...
      {
         return this.var_327 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_397);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_327 != null)
            {
               _loc1_.textColor = uint(this.var_327);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_397 != param1.name)
         {
            this.var_397 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2051 = _loc2_.textWidth;
         this.var_2052 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_327 != _loc2_.color : this.var_327 != null && this.var_327 != PropertyDefaults.const_753) ? new PropertyStruct(PropertyDefaults.const_344,this.var_327,PropertyStruct.const_142,true) : PropertyDefaults.const_1004);
         if(this.var_39)
         {
            if(this.var_39.left != PropertyDefaults.const_895)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_232,this.var_39.left,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_574);
            }
            if(this.var_39.top != PropertyDefaults.const_699)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_239,this.var_39.top,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_476);
            }
            if(this.var_39.right != PropertyDefaults.const_673)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_221,this.var_39.right,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_507);
            }
            if(this.var_39.bottom != PropertyDefaults.const_738)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_255,this.var_39.bottom,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_579);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_344:
                  this.var_327 = _loc2_.value as uint;
                  break;
