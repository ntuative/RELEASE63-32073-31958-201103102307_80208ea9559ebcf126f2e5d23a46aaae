package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1234:Dictionary = createPropertySetterTable();
      ...
      private var var_397:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_397,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_397 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_397,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_184);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_754 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_397);
      }
      ...
      {
         return new Rectangle(this.var_809 * this.maxScrollH,this.var_534 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_397);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1157) ? new PropertyStruct(PropertyDefaults.const_893,this._field.antiAliasType,PropertyStruct.const_55,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1001) : PropertyDefaults.const_1416);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1035 ? new PropertyStruct(PropertyDefaults.const_707,this._autoSize,PropertyStruct.const_55,true,PropertyDefaults.const_1056) : PropertyDefaults.const_1640);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_38,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_142,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_229,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1190 ? new PropertyStruct(PropertyDefaults.const_1118,this._field.gridFitType,PropertyStruct.const_55,true,PropertyDefaults.const_1178) : PropertyDefaults.const_1482);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_753) ? new PropertyStruct(PropertyDefaults.const_344,this._field.textColor,PropertyStruct.const_142,true) : PropertyDefaults.const_1004);
         _loc1_.push(this.var_397 != TextStyleManager.const_184 ? new PropertyStruct(PropertyDefaults.const_351,this.var_397,PropertyStruct.const_55,true,PropertyDefaults.const_719) : PropertyDefaults.const_1000);
         _loc1_.push(this.var_39.left != PropertyDefaults.const_895 ? new PropertyStruct(PropertyDefaults.const_232,this.var_39.left,PropertyStruct.const_41,true) : PropertyDefaults.const_574);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_699 ? new PropertyStruct(PropertyDefaults.const_239,this.var_39.top,PropertyStruct.const_41,true) : PropertyDefaults.const_476);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_673 ? new PropertyStruct(PropertyDefaults.const_221,this.var_39.right,PropertyStruct.const_41,true) : PropertyDefaults.const_507);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_738 ? new PropertyStruct(PropertyDefaults.const_255,this.var_39.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_579);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1080 ? new PropertyStruct(PropertyDefaults.const_688,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1673);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_227,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_227,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_227,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
