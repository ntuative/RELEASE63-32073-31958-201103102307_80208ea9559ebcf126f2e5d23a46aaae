package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1382:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            ...
            var_453 = _loc13_.var_2764;
            if(var_454 != _loc13_.background)
            {
      ...
      {
         return this.var_659 != null ? this.var_659 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_454 = param1;
         var_232 = !!var_454 ? uint(var_232 | var_540) : uint(var_232 & 16777215);
         this.var_170 = this.var_170 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      ...
      {
         var_540 = param1 & 4278190080;
         var_232 = !!var_454 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      ...
      {
         var_540 = param1 << 24;
         var_232 = !!var_454 ? uint(var_540 | var_232) : uint(16777215 & var_232);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      ...
      {
         var_453 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_570,this,this._parent));
            }
            else
            {
               this.var_356.x = 0;
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1021,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_778,var_11);
            this.var_22.visible = var_284;
         }
         return this.var_22;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_84,var_20,_context,var_11,null,this.var_659,this.properties,var_816.concat(),_id) as WindowController;
         _loc2_.var_453 = var_453;
         _loc2_.var_170 = this.var_170;
         ...
         _loc2_.var_540 = var_540;
         _loc2_.var_815 = var_815;
         _loc2_.var_284 = var_284;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2440 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_475)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_20 & 0);
            if(_loc7_ == WindowParam.const_462)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1153,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_894,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_553,this,null));
            }
            if(_loc6_)
            {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_46:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1182;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_187:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_456,this,null));
                     if(testParamFlag(WindowParam.const_190,WindowParam.const_169))
                     {
                     ...
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_520))
                        {
               ...
               case WindowNotifyEvent.const_553:
                  _context.invalidate(this,var_11.union(var_63),WindowRedrawFlag.const_581);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1166,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_303,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_392:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_615,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_250,this._parent,this));
                     }
                  }
                  break;
               ...
               case WindowNotifyEvent.const_430:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1686) == -1)
                     {
                        _loc8_.style = var_84;
                     }
                  }
               ...
               case WindowNotifyEvent.const_549:
                  if(!(var_20 & 0))
                  {
                     if(!this.var_22)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_581);
                     }
                  }
                  else if(var_20 & 0)
                  {
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1164:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1552:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1641:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_340:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_752:
               _loc2_ = "null";
               _loc4_ = true;
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_453);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_453);
      }
         ...
         if(this.var_170 && var_453 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1382,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1382,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_134,WindowParam.const_169);
         var _loc2_:* = !testParamFlag(WindowParam.const_146,WindowParam.const_166);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_374)
               {
                  _loc3_.x += _loc4_;
               }
      ...
      public function destroy() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1143;
         this.update(this,_loc1_);
         this.dispose();
         return true;
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1189,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function unlock() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_67,false);
         _loc1_.type = WindowNotifyEvent.const_1165;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1230,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_378,this,param1));
         return param1;
      }
