package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1681:uint = 1;
      
      protected static const const_1680:uint = 2;
      
      protected static const const_1683:uint = 4;
      
      protected static const const_1682:uint = 3;
      
      protected static const name_3:uint = 7;
      
      public static const const_1598:int = 5;
      ...
      private static var var_669:Array = new Array();
      ...
      protected var var_2862:uint = 0;
      
      protected var var_2771:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1180)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_669[_loc2_] as LibraryLoader;
            ...
            while(var_669.length < const_1411 && false)
            {
               _loc1_ = var_827.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1002 ? uint(this.var_1243 - this.var_2001) : uint(getTimer() - this.var_2001);
      }
      ...
      public function resume() : void
      {
         ...
         {
            this.var_1003 = false;
            if(!this.var_1002 && this.var_231)
            {
               this.var_1243 = -1;
               this.var_2001 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1002 && !_disposed && this.var_1244 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_231,const_1598 - this.var_1244);
            if(this.var_2771)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_446 = LibraryLoader.name_3;
         ...
         if(this.var_446 == LibraryLoader.const_1682)
         {
         ...
         if(this.var_446 == LibraryLoader.name_3)
         {
