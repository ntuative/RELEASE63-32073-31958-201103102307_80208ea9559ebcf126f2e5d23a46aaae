package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1402:int = 10000;
      ...
      private var var_716:IProtocol;
      
      private var _id:String;
      
      private var var_1094:IMessageClassManager;
      
      private var var_308:ICoreCommunicationManager;
      
      private var var_470:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1094 = new MessageClassManager();
         this.var_82 = new Socket();
         this.var_348 = new Timer(const_1402,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_470)
         {
            this.var_470.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_348.start();
         this.var_717 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1094.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_716.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_470)
         {
            this.var_470.messageSent(String(_loc4_),_loc5_.toString());
         }
      ...
      {
         this.var_1094.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_716.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_716.decoder + "\n";
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_716.getMessages(this.var_471,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_470)
               {
                  this.var_470.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1094.getMessageEventClasses(id);
               events = new Array();
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_471.writeByte(this.var_82.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_348.stop();
         this.var_1674 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_717));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1674 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_717));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_717));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_717));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_717));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_717));
