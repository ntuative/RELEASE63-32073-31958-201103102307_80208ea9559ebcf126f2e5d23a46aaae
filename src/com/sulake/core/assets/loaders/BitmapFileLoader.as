package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1008 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_42 = new Loader();
         this.var_1009 = new LoaderContext();
         this.var_1009.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_1009);
         }
      }
      ...
      {
         this.var_1008 = param1.url;
         var_323 = 0;
         this.var_42.load(param1,this.var_1009);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_323 < var_2781)
            {
               ...
               this.var_42.load(new URLRequest(this.var_1008 + (this.var_1008.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_323),this.var_1009);
               return true;
            }
         }
         return false;
