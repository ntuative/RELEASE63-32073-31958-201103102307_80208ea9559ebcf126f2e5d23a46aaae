package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1009:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1009 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_451 = new AssetLibrary("lib-" + this.var_542++);
         this.var_29.push(this.var_451);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1009;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_542++);
         this.var_538.push(_loc3_);
      ...
      public function unload() : void
      {
         ...
         {
            (this.var_538.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_538.length)
            {
               _loc3_ = this.var_538[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  this.var_538.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
