package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      private var var_340:IAssetLibrary;
      ...
      private function defineAssets(param1:XMLList) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc5_.length > 0)
            {
               ...
               _loc12_ = this.var_340.getAssetByName(_loc6_);
               if(_loc12_ != null)
               {
      ...
      private function definePalettes(param1:XMLList) : void
      {
         ...
         for each(_loc3_ in param1)
         {
            if(XMLValidator.checkRequiredAttributes(_loc3_,_loc2_))
            {
               ...
               if(this.var_242[_loc4_] == null)
               {
                  _loc6_ = this.var_340.getAssetByName(_loc5_);
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean, param4:int = 0, param5:int = 0) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            _loc6_ = new BitmapDataAsset(this.var_340.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_340.setAsset(param1,_loc6_);
      ...
      public function disposeAsset(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_340.removeAsset(_loc3_);
               _loc3_.dispose();
            }
            _loc2_.dispose();
         }
      ...
      {
         return this.var_340.getAssetByName(param1) as BitmapDataAsset;
      }
      ...
      private function addLibraryAsset(param1:String, param2:BitmapData) : BitmapDataAsset
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = new BitmapDataAsset(this.var_340.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_340.setAsset(param1,_loc3_);
      ...
      private function disposePaletteAssets(param1:Boolean = true) : void
      {
         ...
         if(this.var_561 != null)
         {
            if(param1 || this.var_561.length > const_1263)
            {
