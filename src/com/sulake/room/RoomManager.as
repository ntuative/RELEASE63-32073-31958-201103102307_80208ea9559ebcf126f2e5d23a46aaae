package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2852:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_737,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_601 == null || this.var_491 == null)
         {
            return;
         }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_600.indexOf(_loc5_) < 0)
            {
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_599.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_599[_loc4_];
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_653)
         {
            return;
         }
         if(this.var_51 == null)
         {
            this._state = const_653;
            return;
         }
         if(this.var_51.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_600.indexOf(param1);
            if(_loc2_ >= 0)
            {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_601.createRoomObjectLogic(_loc18_);
