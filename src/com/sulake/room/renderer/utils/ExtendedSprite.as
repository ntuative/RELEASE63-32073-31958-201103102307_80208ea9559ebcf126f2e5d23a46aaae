package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1377:int = 128;
      
      private var var_1378:Boolean = false;
      
      private var var_2811:Point;
      ...
      {
         if(param1 != this.var_1730 || param2 != this.var_1729)
         {
      ...
      {
         if(this.var_1377 > 255 || bitmapData == null)
         {
            return false;
         }
