package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      {
         if(this.var_1347.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         if(this.var_1348.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_599.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_599[_loc2_]);
      ...
      {
         var _loc5_:* = null;
         var _loc4_:IRoomObjectManager = this.method_14(param3);
         if(_loc4_ != null)
         {
            _loc5_ = _loc4_.createObject(param1,param2);
            if(this.var_167 != null)
            {
               this.var_167.feedRoomObject(_loc5_);
            }
            return _loc5_;
         }
         return null;
      ...
      protected function method_14(param1:int) : IRoomObjectManager
      {
