package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_661:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_283 != null)
         {
            ...
            {
               _loc2_ = this.var_283.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_904,RoomWidgetChatSelectAvatarMessage.const_841];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_904:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_42) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1012))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_42) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1012))
                              {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_182)
                           {
                              _loc13_ = this.var_283.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_391.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_546.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_182:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_546.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_182)
                                    {
                                       this.var_283.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1017 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1017);
            }
            if(this.var_661 == null)
            {
               ...
               this.var_456.y = 0;
               this.var_456.z = 0;
               this.var_661 = _loc4_.getScreenPoint(this.var_456);
               this.var_1017 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_456.x = 0;
            this.var_456.y = 0;
            this.var_456.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_456);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_661.x || _loc8_.y != this.var_661.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_661,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_283)
         {
            _loc2_ = this.var_283.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_391)
         {
            _loc2_ = this.var_391.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1016.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_546.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1524.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1524.remove(param1);
         if(_loc3_ != null)
         {
