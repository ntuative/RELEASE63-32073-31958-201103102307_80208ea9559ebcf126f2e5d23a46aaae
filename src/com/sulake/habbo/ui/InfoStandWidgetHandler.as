package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_649);
         _loc1_.push(RoomWidgetFurniActionMessage.const_822);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_775);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_845);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_789);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1459);
         ...
         _loc1_.push(RoomWidgetChangeMottoMessage.const_849);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_397 || param1.type == RoomWidgetUserActionMessage.const_481 || param1.type == RoomWidgetUserActionMessage.const_573)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetGiveBadgeMessage.GIVE_BADGE:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_649:
            ...
            case RoomWidgetRoomTagSearchMessage.const_775:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_845:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_789:
            ...
            case RoomWidgetPetCommandMessage.const_502:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_849:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_299);
               _loc6_.id = param1.id;
               ...
               else
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     if(this._container.userDefinedRoomEvents != null && param1.category == RoomObjectCategoryEnum.const_30)
                     {
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1090);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1055);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_176)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_768)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_119)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_143)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_740);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1169;
                  }
                  if(!_loc28_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1590);
               }
               else
               {
