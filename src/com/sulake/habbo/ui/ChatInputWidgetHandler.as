package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetChatTypingMessage.const_731);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_728:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_731:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_174.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_1066,HabboToolbarIconEnum.CHATINPUT,param1));
         this._container.events.dispatchEvent(new RoomWidgetChatInputDisplayEvent(RoomWidgetChatInputDisplayEvent.const_763,true));
      }
      
      public function getProcessedEvents() : Array
      {
         return [RoomSessionChatEvent.const_449];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_449:
