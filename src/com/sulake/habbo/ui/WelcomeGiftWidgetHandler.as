package com.sulake.habbo.ui
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         this._container.connection.addMessageEvent(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this._container.connection.addMessageEvent(new ChangeEmailResultEvent(this.onChangeEmailResult));
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_623);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_848);
         return _loc1_;
      }
