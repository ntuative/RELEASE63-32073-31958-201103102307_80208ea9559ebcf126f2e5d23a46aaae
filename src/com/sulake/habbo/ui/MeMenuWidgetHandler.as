   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_681,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_800,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_174 != null)
            {
               this.var_174.events.removeEventListener(HabboToolbarEvent.const_68,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_485,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_681,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_800,this.onHabboClubSubscriptionChanged);
         }
         this.var_174 = this._container.toolbar;
         if(this.var_174 != null)
         {
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_485,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1301)
            {
               ...
               this.var_1595 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1595;
            }
         }
         if(this.var_174 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1212,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_174.events.dispatchEvent(_loc5_);
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetSelectEffectMessage.const_665);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_859);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_616);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_748);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_361);
         _loc1_.push(RoomWidgetStopEffectMessage.const_733);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1667);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1054);
         ...
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1025);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_762);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_827);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_892);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1596);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_727);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_901);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_827:
            ...
            case RoomWidgetGetEffectsMessage.const_642:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_665:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_361:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1028)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_189,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_748:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1201:
                        this._catalog.openCatalogPage(CatalogPageName.const_1493,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1226:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_298);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1614:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_77);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1518:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_616:
            case RoomWidgetStopEffectMessage.const_733:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1054:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_762:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_819:
               ...
               if(this.var_174)
               {
                  this.var_174.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_634:
               ...
               {
                  this.var_174.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_438,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_336:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_892:
            ...
            case RoomWidgetStoreSettingsMessage.const_727:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_406,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_901:
            ...
            case RoomWidgetClothingChangeMessage.const_364:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_891));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_747));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_485:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_428));
         }
      }
