package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_1542:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_90.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_1542 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
         ...
         this.var_17.addEventListener(WindowEvent.const_50,this.onResized);
      }
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_90)
         {
            this.var_57.controller.activateQuest(this.var_90);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc38_:* = null;
         var _loc39_:* = null;
         var _loc1_:String = ["quest",this.var_57.code,this.var_90.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_57.code,"type_" + this.var_90.type.toLowerCase()].join(".");
         ...
         if(this.var_90.type == QuestTypeEnum.FIND_STUFF)
         {
            ...
            _loc37_ = this.var_57.controller.questEngine.sessionDataManager.getFloorItemDataByName(_loc35_,_loc36_);
            if(_loc37_)
            {
               _loc39_ = "";
               _loc38_ = this.var_57.controller.questEngine.roomEngine.getFurnitureImage(_loc37_.id,new Vector3d(90,0,0),64,this,_loc36_,_loc39_);
               this.var_1543 = _loc38_.id;
               if(_loc38_ && _loc38_.data)
               {
                  this.imageReady(_loc38_.id,_loc38_.data);
               }
               this.var_57.controller.questEngine.localization.registerParameter(_loc7_,"name",_loc37_.title);
            }
         }
         ...
         {
            this.var_57.controller.questEngine.setImageFromAsset(_loc15_,this.var_90.questBadgeAchievementTypeId,this.onPreviewImageReady);
         }
         else
         {
            this.var_1543 = -1;
         ...
         {
            case QuestStatusEnum.const_465:
         ...
         this.var_57.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_90.rewardCurrencyAmount.toString());
         ...
         var _loc32_:String = "icon_" + this.var_57.code + "_reward_" + this.var_90.rewardCurrencyAmount;
         ...
         if(_loc33_)
         {
            this.var_548 = new Timer(20,1);
            this.var_548.addEventListener(TimerEvent.TIMER,this.onShowReward);
            this.var_548.start();
      ...
      private function setText(param1:String, param2:String, param3:Boolean = true, param4:Boolean = false) : void
      {
         ...
         if(_loc5_)
         {
            ...
            if(param4 && _loc5_ is IHTMLTextWindow)
            {
               ...
               (_loc5_ as IHTMLTextWindow).linkTarget = LinkTarget.const_777;
            }
         }
      }
