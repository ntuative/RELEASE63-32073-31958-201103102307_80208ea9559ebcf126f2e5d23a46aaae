package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_613 = param1;
            this.var_55.initConnection(HabboConnectionType.const_225);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_102,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_613 = this.var_158.getKey("sso.ticket",null);
         this.var_1813 = this.var_158.getKey("flash.client.url","");
         this.var_2547 = this.var_158.getKey("external.variables.txt","");
         if(this.var_221 == null)
         {
            this.var_221 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_55.mode = HabboConnectionType.const_90;
            if(this.var_613)
            {
               this.var_55.initConnection(HabboConnectionType.const_225);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this.var_17.addEventListener(HabboLoginDemoView.const_534,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_55.mode = HabboConnectionType.const_1222;
            }
         }
         this.var_55.initConnection(HabboConnectionType.const_225);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_687);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2549 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_55.mode)
         {
            case HabboConnectionType.const_90:
               ...
               this.var_1426 = _loc4_;
               this.var_221.loadBannerImage(_loc7_ + "?token=" + this.var_1426,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1222:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1484:
               this.var_928 = this.generateRandomHexString(30);
               ...
               this.var_499.init(this.var_928);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2549);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1813,this.var_2547));
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2548)
         {
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         if(_loc2_.length > 0)
         {
            _loc2_ = this.setReasonProperty(_loc2_,param1.method_13);
            _loc2_ = this.setOriginProperty(_loc2_);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1426);
