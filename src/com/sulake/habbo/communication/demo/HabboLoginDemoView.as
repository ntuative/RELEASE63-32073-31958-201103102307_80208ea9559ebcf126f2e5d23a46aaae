package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_534:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_155.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_132,HabboWindowStyle.const_43,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_155.habboConfiguration.getKey("use.sso","false") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         {
            dispatchEvent(new Event(const_534));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_132.removeEventListener(SSOTicket.const_403,this.onParsedTicketSuccess);
         ...
         this.var_132.addEventListener(SSOTicket.const_403,this.onParsedTicketSuccess);
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_155.shockwaveClientUrl = this.var_132.shockwaveClientUrl;
