package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_291:ChargeConfirmationDialog;
      ...
      private var var_1052:ClubGiftController;
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_185.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_309.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_309.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_85)
         {
            _loc3_ = this.var_309.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_691.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      {
         this.var_174.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_689)
         {
            if(!this.var_309.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_174 != null && _loc2_)
         {
            this.var_174.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_290.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_290 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_290.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_87:
               this.var_1577 = param1.session.isPrivateRoom;
               if(this.var_91 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1052 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_692 && this.var_692 != "")
         {
            this.var_335.openPage(this.var_692);
            this.var_692 = "";
            this.var_840 = -1;
         }
         else if(this.var_840 > -1)
         {
            this.var_335.openPageById(this.var_840,this.var_1578);
            this.var_840 = -1;
            this.var_1578 = -1;
            this.var_692 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_290.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_290.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2127 && this.var_529 != null)
         {
            this.var_529.playSound(HabboSoundTypesEnum.const_984);
         }
         this.var_2127 = false;
         if(this.var_291 != null)
         {
            this.var_291.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_74,this.var_98.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2126 && this.var_529 != null)
         {
            this.var_529.playSound(HabboSoundTypesEnum.const_997);
         }
         this.var_2126 = false;
         if(this.var_291 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1052.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_290.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_291 == null)
         {
            this.var_291 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_291.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_691.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_691.add(_loc2_.productCode,_loc3_.slice());
            this.var_290.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == this.var_185.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
