package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_936:String = "bg";
       
      
      protected var var_17:IWindowContainer;
      
      private var var_269:IItemGrid;
      ...
      {
         this.var_17.getChildByName(const_936).style = HabboWindowStyle.const_32;
      }
      
      public function deActivate() : void
      {
         this.var_17.getChildByName(const_936).style = 3;
      }
