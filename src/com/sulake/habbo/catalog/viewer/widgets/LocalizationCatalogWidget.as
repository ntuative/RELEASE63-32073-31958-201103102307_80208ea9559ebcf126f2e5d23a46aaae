package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class LocalizationCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function onClickLink(param1:WindowMouseEvent) : void
      {
         ...
         switch(page.layoutCode)
         {
            ...
            case "info_pixels":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openInventoryCategory(InventoryCategory.const_405);
                     break;
                  case "ctlg_text_7":
            ...
            case "club1":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openCatalogPage(CatalogPageName.const_189,true);
               }
               break;
            case "club_buy":
               switch(_loc4_)
      ...
      private function retrieveCatalogImage(param1:String) : void
      {
         ...
         var _loc5_:String = this.var_971[param1];
