package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_609[this.var_1156][this.var_1795];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1156 = var_1001.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1156];
         var _loc3_:Array = this.var_609[this.var_1156] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1795 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1795] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_539 || _loc1_.pricingModel == Offer.const_455)
            {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_85 || _loc3_.productType == ProductTypeEnum.const_92)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_609.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_609[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in this.var_609)
         {
