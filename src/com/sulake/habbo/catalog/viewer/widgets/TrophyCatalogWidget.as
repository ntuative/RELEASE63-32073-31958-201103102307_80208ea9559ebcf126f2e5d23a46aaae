package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_275.getWithIndex(this.var_320);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_801);
            if(_loc3_ == null)
            {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_275.getWithIndex(this.var_320);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_801);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_320;
         if(this.var_320 >= this.var_275.length)
         {
            this.var_320 = 0;
         }
         var _loc2_:Map = this.var_275.getWithIndex(this.var_320);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_320 < 0)
         {
            this.var_320 = this.var_275.length - 1;
         }
         var _loc2_:Map = this.var_275.getWithIndex(this.var_320);
         if(_loc2_ != null)
         {
