package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1343:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_502 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_502 < 8)
         {
            return false;
         }
         this.var_2442 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_196 != null && this.var_196.length > 0)
         {
            this.var_366 = this.var_196[0];
         }
         else
         {
            this.var_366 = -1;
         }
         this._offers.add(this.var_502,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_196 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1343 && _loc2_ < this.var_196.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_502,this.var_196[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_196 != null && this.var_196.length > 0)
         {
            ...
            this.var_366 = this.var_196[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_502,this.var_366),this.getRaceLocalizationKey(this.var_502,this.var_366));
            }
         }
         return this.getRaceLocalizationKey(this.var_502,this.var_366);
      }
