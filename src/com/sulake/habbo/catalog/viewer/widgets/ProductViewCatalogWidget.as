package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1381:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_894 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1125 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1739 = new Point(this.var_87.x,this.var_87.y);
         this.var_482 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1381 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1738 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_894.text = _loc4_;
         this.var_1125.text = _loc5_;
         this.var_894.height = this.var_894.textHeight + 5;
         this.var_1125.y = this.var_894.y + this.var_894.height;
         this.var_1125.height = Math.max(130,this.var_1125.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_425:
                  _loc6_ = this.var_1738.clone();
                  if(this.var_482 != null)
                  {
                     this.var_482.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_482,this.var_1381,this.var_1778);
                     ...
                     case ProductTypeEnum.const_271:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_326,AvatarAction.const_543);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2439)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2439 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_87 != null && true)
         {
            ...
            this.var_87.x = this.var_1739.x;
            this.var_87.y = this.var_1739.y;
            if(param3 != null)
            {
