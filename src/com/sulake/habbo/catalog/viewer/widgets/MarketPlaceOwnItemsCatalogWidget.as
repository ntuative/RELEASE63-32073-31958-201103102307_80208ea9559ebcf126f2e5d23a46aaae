   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1104.add(MarketPlaceOfferState.const_999,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1104.add(MarketPlaceOfferState.const_441,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1104.add(MarketPlaceOfferState.const_201,_loc2_);
            }
         }
      ...
      private function updateList(param1:Map) : void
      {
         ...
         this.updateStatusDisplay(this.const_1701,_loc6_.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            ...
            _loc4_ = this.var_1104.getValue(_loc11_.status);
            if(_loc4_)
            {
               ...
               if(!(!_loc12_ || _loc12_.disposed))
               {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_999)
                  {
