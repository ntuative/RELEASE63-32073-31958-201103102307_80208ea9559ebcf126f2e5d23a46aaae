package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1735:uint = 4.293848814E9;
      
      private const const_1736:uint = 4.294967295E9;
      
      private const const_1999:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1820 = _loc1_.stuffTypes;
            this.var_755 = _loc1_.boxTypes;
            this.var_754 = _loc1_.ribbonTypes;
            this.var_1168 = this.var_1820[0];
            this.var_363 = this.var_755[0];
            this.var_364 = this.var_754[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_364 < 0)
         {
            this.var_364 = this.var_754.length - 1;
         }
         if(this.var_364 > this.var_754.length - 1)
         {
            this.var_364 = 0;
         }
         if(this.var_363 < 0)
         {
            this.var_363 = this.var_755.length - 1;
         }
         if(this.var_363 > this.var_755.length - 1)
         {
            this.var_363 = 0;
         }
         var _loc1_:int = this.var_755[this.var_363] * 1000 + this.var_754[this.var_364];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_92.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1168,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1820;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1168);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_755[this.var_363]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_754[this.var_364]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_92,this.var_1430,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_92.offerId,this.var_1430);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_109:
               ...
               for each(_loc7_ in this.var_223)
               {
                  ...
                  if(_loc5_.length >= this.const_2000)
                  {
                     break;
                  }
               }
            ...
            case WindowMouseEvent.const_46:
               ...
               break;
            case WindowKeyboardEvent.const_346:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_365 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_365 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_365) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_446:
               this.showSelectors(false);
               break;
            case WindowEvent.const_669:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_255 == null || this.var_615 == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_365) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_365);
         }
         this.var_365 = param1;
         if(this.var_365 < 0)
         {
            this.var_365 = _loc2_.numListItems - 1;
         }
         if(this.var_365 >= _loc2_.numListItems)
         {
            this.var_365 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_365) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1999;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1735) : uint(this.const_1736);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1168;
               }
            }
            _loc4_++;
         }
