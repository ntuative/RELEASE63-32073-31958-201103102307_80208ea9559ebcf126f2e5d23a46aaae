package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_42,80,"g"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_42,74,"h"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_42,416,"o"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_42,352,"p"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_42,304,"q"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_42,336,"r"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_42,748,"u"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_42,438,"v"));
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1580 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1580 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_61 = IItemListWindow(this.var_172.findChildByName("item_list"));
         ...
         this.var_1054 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_172.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         return Boolean(this.var_1054.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1054.getText();
         var _loc3_:String = "model_" + this.var_1053.name;
