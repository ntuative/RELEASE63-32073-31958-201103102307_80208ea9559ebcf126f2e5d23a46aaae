package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      {
         this.var_334 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_334));
      ...
      {
         if(param1 != this.var_334 || this.var_1045 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1045 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1668)
         {
            this.var_690.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1443)
         {
            this.var_690.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1601)
         {
            this.var_1047.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1398)
         {
            ...
            this.setTagError(this.var_837,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1588)
         {
            ...
            this.setTagError(this.var_837,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1462)
         {
            this.var_836.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_690.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_446,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_678,this.onDoorModePasswordUnselect);
         ...
         this.var_690 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1047 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_838 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_837 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_836 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1051 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1043 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1046 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         ...
         this.var_1573 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1292 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1048 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1044 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1575 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         ...
         this.var_1050 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2123 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2124 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1291 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1291.mouseThreshold = 0;
         this.var_1291.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1050.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1573.visible = this._inRoom;
         this.var_1575.visible = this._inRoom;
         this.var_2124.visible = this.var_459;
         this.var_2123.visible = !this.var_459;
         if(this.var_459)
         {
            this.var_1044.visible = true;
            this.var_1290.visible = false;
            this.refreshFlatControllers();
            this.var_1044.height = Util.getLowestPoint(this.var_1044) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this.var_1292.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1292.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1048.height = Util.getLowestPoint(this.var_1048) + 4;
         }
         this.var_1291.text = !!this.var_459 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1573.name,this.var_1292.name,this.var_1048.name,this.var_1044.name,this.var_1290.name,this.var_1575.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_690.setText(_loc1_.name);
         this.var_1047.setText(_loc1_.description);
         this.var_836.setText("");
         this.var_1051.setText("");
         ...
         this.setTag(this.var_837,_loc1_.tags[1]);
         if(this.var_1043)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1046)
         {
            ...
            {
               this.var_1046.select();
            }
            else
            {
               this.var_1046.unselect();
            }
         }
         if(this.var_1049)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_690.getText();
         _loc2_.description = this.var_1047.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_540;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_114)
         {
            _loc8_ = this.var_836.getText();
            _loc9_ = this.var_1051.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_836.clearErrors();
               this.var_1051.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = this.var_1046.isSelected;
         ...
         this.addTag(this.var_837,_loc2_.tags);
         this.clearErrors();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_334);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_74.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_334]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_239.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_239.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_239.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_239.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_239.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_239.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_239.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_239);
         this.var_239.findChildByName("ruler").visible = true;
         ...
         if(this.var_74.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_239,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_334));
      }
