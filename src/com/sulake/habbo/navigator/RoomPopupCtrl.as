package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2298 = new RoomThumbnailRenderer(param1);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_175,this.var_115);
         if(this.var_115.ownerName != "" && this.var_115.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_175,!!this.var_115.event ? this.getEventCtg(this.var_115.categoryId) : this.getRoomCtg(this.var_115.categoryId));
         this.refreshRoomDesc(this.var_175,this.var_115);
         this.refreshExtraCont();
         this.refreshInfo(this.var_175,"trading_allowed",this.var_115.allowTrading);
         this.refreshInfo(this.var_175,"doormode_doorbell",this.var_115.doorMode == 1);
         this.refreshInfo(this.var_175,"doormode_password",this.var_115.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_175,this.var_115.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1029.refreshTags(_loc1_,this.var_115.tags);
         ...
         this.var_2298.refreshThumbnail(_loc1_,this.var_115.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_223,Tabs.const_218,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
