package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2298:RoomThumbnailRenderer;
      
      private var var_836:GuestRoomPasswordInput;
      
      private var var_312:GuestRoomDoorbell;
      
      private var var_1151:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2491 = new Array();
         ...
         this.var_607 = new RoomInfoViewCtrl(this);
         this.var_1150 = new RoomCreateViewCtrl(this);
         this.var_2298 = new RoomThumbnailRenderer(this);
         this.var_836 = new GuestRoomPasswordInput(this);
         this.var_312 = new GuestRoomDoorbell(this);
         this.var_398 = new Tabs(this);
         this.var_1151 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_323,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_607.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_174.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_174.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_174.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_310.startSearch(Tabs.const_223,Tabs.const_379,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_310.startSearch(Tabs.const_293,Tabs.const_264);
         this.var_398.getTab(Tabs.const_293).tabPageDecorator.tabSelected();
      }
