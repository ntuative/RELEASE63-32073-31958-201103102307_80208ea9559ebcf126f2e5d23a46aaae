package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1865 = IButtonWindow(this.find("top_tab"));
         this.var_1864 = IButtonWindow(this.find("obj_tab"));
         this.var_2623 = IWindowContainer(this.find("tile_grid"));
         this.var_2624 = IWindowContainer(this.find("now_editing_container"));
         ...
         Util.setProcDirectly(this.var_1865,this.onTopTabButton);
         Util.setProcDirectly(this.var_1864,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1866,this.var_68.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_1865,this.var_68.mode != ThumbnailEditorModel.const_61);
         this.setEnabled(this.var_1864,this.var_68.mode != ThumbnailEditorModel.const_35);
      }
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_518,HabboWindowStyle.const_43,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_323,HabboWindowStyle.const_43,HabboWindowParam.const_60,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
