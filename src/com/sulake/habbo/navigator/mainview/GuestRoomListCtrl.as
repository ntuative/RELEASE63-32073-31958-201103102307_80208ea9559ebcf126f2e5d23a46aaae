package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_472:RoomPopupCtrl;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_472 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1444,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"home",this.method_5(param2),null,0);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(this.var_472.visible && this.var_2325)
            {
               return;
            }
            ...
            this.var_472.room = _loc4_;
            this.var_472.showPopup(param2);
         }
      ...
      private function refreshFavouriteIcon(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         var _loc4_:Boolean = this.method_5(param2);
      ...
      private function method_5(param1:GuestRoomData) : Boolean
      {
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1345.tags[0];
            this.var_1345.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2324 - _loc2_.stageX);
         this.var_2324 = _loc2_.stageX;
         this.var_2325 = _loc3_ > 2;
      }
   }
}
