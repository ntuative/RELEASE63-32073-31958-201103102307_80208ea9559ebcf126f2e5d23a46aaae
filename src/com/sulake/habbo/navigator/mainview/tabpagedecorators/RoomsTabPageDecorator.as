package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_270,Tabs.const_334);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_270,Tabs.const_696);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_270,Tabs.const_334,"" + _loc3_);
         }
      }
   }
}
