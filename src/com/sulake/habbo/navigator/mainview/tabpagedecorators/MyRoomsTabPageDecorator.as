package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2845:IWindowContainer;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_458 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_458.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_458 == null ? 0 : int(this.var_458.selection);
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_629;
         }
         if(param1 == 3)
         {
            return Tabs.const_791;
         }
         if(param1 == 4)
         {
            return Tabs.const_870;
         }
