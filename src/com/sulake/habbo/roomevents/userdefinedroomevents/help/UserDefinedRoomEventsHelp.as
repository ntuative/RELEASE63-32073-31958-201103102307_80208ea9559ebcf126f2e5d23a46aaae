package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1684 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1101 = this.var_1684.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1101)
         {
            this.var_1101.procedure = this.onButtonClick;
         }
         this.var_1100 = this.var_1684.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1100)
         {
      ...
      {
         if(this.var_249 >= this.var_79.length - 1)
         {
      ...
      {
         ++this.var_249;
         this.var_249 = Math.min(this.var_249,this.var_79.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_79[this.var_249][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_79[this.var_249][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_79[this.var_249][1]).value;
