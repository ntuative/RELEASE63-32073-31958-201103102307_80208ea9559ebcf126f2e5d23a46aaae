package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
   ...
   public class AvatarEntersRoom implements TriggerConf
   {
      ...
      {
         this._cont = param1;
         this.getCertainAvatarRadio().addEventListener(WindowEvent.const_446,this.onCertainAvatarSelect);
         this.getCertainAvatarRadio().addEventListener(WindowEvent.const_678,this.onCertainAvatarUnselect);
      }
