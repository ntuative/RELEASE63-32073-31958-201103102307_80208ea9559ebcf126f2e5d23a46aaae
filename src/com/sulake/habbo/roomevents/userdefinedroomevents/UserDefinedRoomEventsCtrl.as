package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1335:int = 2;
      ...
      private var var_1653:TriggerConfs;
      
      private var var_1654:ActionTypes;
      
      private var var_1655:ConditionTypes;
      
      private var var_247:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_709:RoomObjectHightLighter;
      
      private var var_136:UserDefinedRoomEventsHelp;
      
      private var var_1080:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1653 = new TriggerConfs();
         this.var_1654 = new ActionTypes();
         this.var_1655 = new ConditionTypes();
         this.var_247 = new Dictionary();
         super();
         this.var_81 = param1;
         this.var_709 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1080 = new SliderWindowController(this.var_81,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_81.assets,0,20,1);
         this.var_1080.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1080.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_709.hideAll(this.var_247);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_709.showAll(this.var_247);
         if(this.var_36 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_36);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1080.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1080.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1335) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1335 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1653);
         this.refreshConfigureElement(this.var_1654);
