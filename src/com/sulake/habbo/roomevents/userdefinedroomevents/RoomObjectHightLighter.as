package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_81.roomEngine.getRoomObject(this.var_81.roomId,this.var_81.roomCategory,param1,RoomObjectCategoryEnum.const_30);
      }
