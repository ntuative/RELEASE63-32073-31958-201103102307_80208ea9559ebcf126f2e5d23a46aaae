package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_600:String = "temporary_room";
      ...
      private static const const_1321:String = "tile_cursor";
      
      private static const const_953:int = -3;
      
      private static const const_1320:String = "selection_arrow";
      
      private static const const_952:String = "overlay";
      ...
      private var var_919:IRoomRendererFactory = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_919.release(new IIDRoomRendererFactory());
            this.var_919 = null;
         }
         ...
         if(this.var_360 != null)
         {
            ...
            {
               _loc2_ = this.var_360.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_360.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_360.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_47 != null)
         {
            ...
            _loc2_ = this.var_47.getRoom(this.getRoomIdentifier(this.var_102,this.var_103));
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_360.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_102 || _loc6_ != this.var_103 || !this.var_1152)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_656) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_698) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_830) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_817) + 0.5;
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_47 != null)
         {
            this.var_47.addObjectUpdateCategory(RoomObjectCategoryEnum.const_30);
            this.var_47.addObjectUpdateCategory(RoomObjectCategoryEnum.const_27);
            this.var_47.addObjectUpdateCategory(RoomObjectCategoryEnum.const_34);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_919 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_682,this.onContentLoaderReady);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_298.events.addEventListener(AdEvent.const_491,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_309;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_23 != null)
         {
            ...
            {
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_240,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_498,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMouseEvent.const_511,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.ROOM_OBJECT_STATE_CHANGE,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectStateChangeEvent.const_672,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_145,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_133,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_147,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_155,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_128,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_152,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_139,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_107,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectWidgetRequestEvent.const_141,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_444,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_551,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_USE_HABBOWHEEL,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_514,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_469,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_532,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_571,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_528,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_STOP,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_492,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_424,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_580,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectFurnitureActionEvent.const_494,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_63,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_488,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectMoveEvent.const_439,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_290,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_575,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_386,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomAdEvent.const_338,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_572,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_1026,this.roomObjectEventHandler);
               this.var_23.events.addEventListener(RoomObjectRoomActionEvent.const_499,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_23 == null || this.var_491 == null || this.var_47 == null || this.var_919 == null || this._communication == null || this.var_158 == null || !this.var_2494)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_493 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_643,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_361.length)
            {
               _loc3_ = this.var_361.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_427,param1,param2));
            }
            else
            {
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_493)
         {
            _loc5_ = this.var_361.remove(_loc4_);
            if(_loc5_ != null)
            {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_746,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1077,_loc13_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_331,const_601,_loc8_) as IRoomObjectController;
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_861,param3);
         ...
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_906,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_426,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_247);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_755,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_641,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_755,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1186,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1198,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_954,const_1321,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         if(this.var_158.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_953,const_1320,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_331,RoomObjectCategoryEnum.const_76);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_361.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_361.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_861,param3);
         ...
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_906,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1564,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1204,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1073,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_360.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_868,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_919.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_755);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1186);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1198);
      ...
      {
         var _loc8_:int = param2 - this.var_1409;
         ...
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1152 = true;
               this.var_918 = false;
               this.var_2495 = this.var_1409;
               this.var_2493 = this.var_1410;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1152)
            {
               if(!this.var_918)
               {
                  _loc8_ = param2 - this.var_2495;
                  _loc9_ = param3 - this.var_2493;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_102,this.var_103,param1);
         if(_loc9_ != null)
         {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_552,this.var_102,this.var_103,-1,RoomObjectCategoryEnum.const_168));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_76 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_331,const_601);
                     this.var_76.handleRoomObjectEvent(_loc14_,this.var_102,this.var_103);
                  }
               }
            }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_952) as Sprite;
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc5_ = this.getRoomObjectImage(this.var_102,this.var_103,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_102,this.var_103,this.var_1411);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1409 - _loc5_.data.width / 2;
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_102,this.var_103,this.var_1411);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_102,this.var_103,this.var_1411);
         if(_loc1_ != null)
         {
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_76 != null)
         {
            return this.var_76.modifyRoomObject(this.var_102,this.var_103,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_76 != null)
         {
            ...
            {
               return this.var_76.modifyWallItemData(this.var_102,this.var_103,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_76 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_76.deleteWallItem(this.var_102,this.var_103,param1);
            }
         }
         return false;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_102,this.var_103);
         ...
         if(this.var_76 != null)
         {
            return this.var_76.initializeRoomObjectInsert(this.var_102,this.var_103,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_76 != null)
         {
            this.var_76.cancelRoomObjectInsert(this.var_102,this.var_103);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_953,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_954,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_377,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1126,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1090,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1055,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_319,param1,param2,param3,RoomObjectCategoryEnum.const_30));
         }
         var _loc15_:ISelectedRoomObjectData = this.getPlacedObjectData(param1,param2);
         if(_loc15_ && Math.abs(_loc15_.id) == param3 && _loc15_.category == RoomObjectCategoryEnum.const_30)
         {
            this.selectRoomObject(param1,param2,param3,RoomObjectCategoryEnum.const_30);
         }
         return true;
      }
      ...
      public function addObjectFurnitureByName(param1:int, param2:int, param3:int, param4:String, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN) : Boolean
      {
         ...
         if(_loc12_ && Math.abs(_loc12_.id) == param3 && _loc12_.category == RoomObjectCategoryEnum.const_30)
         {
            this.selectRoomObject(param1,param2,param3,RoomObjectCategoryEnum.const_30);
         }
         return true;
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_377,_loc11_,true);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1148) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1141);
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_319,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_886,this.var_102,this.var_103,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_76 != null)
         {
            this.var_76.handleRoomObjectEvent(param1,this.var_102,this.var_103);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_461);
                     break;
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_173,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               _loc8_.addPlane(RoomPlaneData.const_160,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
               _loc8_.addPlane(RoomPlaneData.const_160,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc8_.addPlane(RoomPlaneData.const_288,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.getXML();
               param1.getEventHandler().initialize(_loc9_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_881,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_765,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_637,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc11_:IRoomInstance = this.var_47.getRoom(const_600);
         if(_loc11_ == null)
         {
            _loc11_ = this.var_47.createRoom(const_600,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_30:
            case RoomObjectCategoryEnum.const_27:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_226,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_461,param7);
               break;
            case RoomObjectCategoryEnum.const_34:
         ...
         {
            this.var_1153.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1119,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_102,this.var_103,const_331,RoomObjectCategoryEnum.const_76,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_47.getRoom(const_600);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1119);
               ...
               _loc13_ = this.var_1153.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_370,param1.image,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1039,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1152,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1161,RoomObjectVariableEnum.const_370,param1.clickUrl);
