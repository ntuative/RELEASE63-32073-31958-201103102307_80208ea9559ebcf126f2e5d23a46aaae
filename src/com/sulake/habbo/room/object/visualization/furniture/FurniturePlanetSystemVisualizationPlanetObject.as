package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1252:Number = 30;
      ...
      public function FurniturePlanetSystemVisualizationPlanetObject(param1:String, param2:int, param3:Number, param4:Number, param5:Number, param6:Number)
      {
         ...
         this.var_2156 = param4 * 0 * 2 / 360;
         this.var_1600 = param5 * 0 * 2 / 360;
         this._height = param6;
         this.var_1056 = 0;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1056 += this.var_2156 / const_1252;
      ...
      {
         var _loc3_:Number = this.var_1267 * Math.cos(this.var_1056 + this.var_1600);
         var _loc4_:Number = this.var_1267 * Math.sin(this.var_1056 + this.var_1600);
