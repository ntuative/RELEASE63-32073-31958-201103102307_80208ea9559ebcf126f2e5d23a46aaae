package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_673:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_286.assign(param2);
         this.var_287 = new Vector3d();
         this.var_287.assign(param3);
         this.var_673 = new Vector3d();
         this.var_673.assign(param2);
         this.var_672 = new Vector3d();
         this.var_672.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != this.var_2086)
         {
            if(!param1)
            {
               this.var_286.assign(this.var_673);
               this.var_287.assign(this.var_672);
            }
            else
            {
               this.var_286.assign(this.var_673);
               this.var_286.mul(this.var_672.length / this.var_673.length);
               this.var_287.assign(this.var_672);
               this.var_287.mul(this.var_673.length / this.var_672.length);
            }
            this.var_1554 = -1;
            this.var_1284 = this.var_1284 - 1;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = Number(this.var_286.length * param1.scale);
            _loc6_ = Number(this.var_287.length * param1.scale);
            if(_loc5_ < 1)
            {
               _loc5_ = 1;
            }
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_83 == null && this.var_1030 != null || this.var_286 == null || this.var_287 == null || this.var_550 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1554)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1284 || _loc4_.y != this.var_2088 || _loc4_.z != this.var_2085 || param1.scale != this.var_2084))
            {
               this.var_1284 = _loc4_.x;
               this.var_2088 = _loc4_.y;
               this.var_2085 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1030);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_144.z - _loc7_,this.var_111.z - _loc7_,this.var_85.z - _loc7_,this.var_110.z - _loc7_);
               this.var_2087 = _loc8_;
