package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_300:AnimatedFurnitureVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_300 = param1 as AnimatedFurnitureVisualizationData;
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this.var_300.isImmediateChange(this.var_867,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this.var_300.hasAnimation(this.var_867,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_114 != null)
         {
            this.var_114.setLayerCount(this.var_611);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         {
            this.var_867 = param1;
            this.var_611 = this.var_300.getLayerCount(param1);
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : Array
      {
         ...
         if(_loc3_ == 0)
         {
            _loc3_ = this.var_300.getStartFrame(param2,_loc4_,_direction);
         }
         _loc3_ += 1;
         param1.frameCounter = _loc3_;
         var _loc6_:* = null;
         param1.animationOver = true;
         var _loc7_:int = this.var_611 - 1;
         while(_loc7_ >= 0)
         {
            ...
            if(!_loc8_)
            {
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats >= 0 && _loc12_ <= 0)
               {
                  ...
                  if(_loc11_ == AnimationFrame.const_1058)
                  {
                     _loc10_ = this.var_300.getFrame(param2,_loc4_,_direction,_loc7_,_loc3_);
                  }
                  else
                  {
                     _loc10_ = this.var_300.getFrameFromSequence(param2,_loc4_,_direction,_loc7_,_loc11_,_loc10_.activeSequenceOffset + _loc10_.repeats,_loc3_);
                  }
