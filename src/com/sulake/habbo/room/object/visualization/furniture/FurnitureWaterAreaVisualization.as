package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1236:String = "shore";
      ...
      {
         if(this.var_2036 == param1 && this.var_2037 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1236)
            {
               this.var_1519 = _loc2_;
               this.var_2036 = param1;
               this.var_2037 = _direction;
               return this.var_1519;
            }
            _loc2_--;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_455 == 0 || this.var_544 == 0)
         {
            ...
            this.var_455 = _loc2_.getNumber(RoomObjectVariableEnum.const_286);
            this.var_544 = _loc2_.getNumber(RoomObjectVariableEnum.const_341);
         }
         this.var_390 = [];
         this.var_543 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_455 * 2 + this.var_544 * 2)
         {
            this.var_390.push(false);
            this.var_543.push(ShoreMaskCreatorUtility.const_81);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_71,getSize(param3),this.var_390,this.var_543,assetCollection);
      }
