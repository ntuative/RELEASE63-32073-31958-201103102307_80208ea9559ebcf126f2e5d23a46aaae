package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1632:String = "cone";
      
      public static const const_1591:String = "plane";
      
      public static const const_1429:String = "sphere";
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_346)
         {
            _loc1_.dispose();
         }
         this.var_346 = null;
      ...
      public function reset() : void
      {
         ...
         this.var_871 = 0;
         this.var_926 = false;
         this.init(0,0,0,this._direction,this.var_2301,this.var_870,this.var_2306,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1087.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_926 = true;
         if(this.var_871 < this.var_1340)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2305)
         {
            switch(this.var_2302)
            {
               case const_1632:
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1087.length);
         return this.var_1087[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_871 < this.var_1340)
         {
            if(this.age % this.var_2304 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_871 < this.var_1340)
         {
            ...
            this.y = (2 - this.var_248) * this.y - (1 - this.var_248) * this.lastY + this.var_1666 * this.var_870 * this.var_870;
         ...
         for each(_loc2_ in this.var_346)
         {
            ...
            _loc2_.y = (2 - this.var_248) * _loc2_.y - (1 - this.var_248) * _loc2_.lastY + this.var_1666 * this.var_870 * this.var_870;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_346.splice(this.var_346.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
