package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1628:int = const_355;
      ...
      public static const const_308:int = const_117;
      ...
      private var var_2246:Number = -1.0;
      
      private var var_2245:Number = 1.0;
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this.var_666,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_582,param6,param7);
                     return param1;
                  }
                  return this.var_30;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1685 == const_117)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_582);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_582,this.var_30.width,this.var_582);
         }
