package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_565:PlaneTexture;
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_565 != null)
         {
            _loc2_ = this.var_565.getBitmap(param1);
            if(_loc2_ != null)
            {
         ...
         if(this.var_565 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  _loc3_ = Math.min(this.var_1063,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_1063,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_1063,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = this._extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = this.var_848[_loc6_ % this.var_848.length] as IGraphicAsset;
