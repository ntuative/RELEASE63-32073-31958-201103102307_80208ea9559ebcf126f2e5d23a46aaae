package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1390:int = 16777215;
      
      public static const const_1448:int = 13421772;
      
      private static const const_923:int = 16777215;
      
      private static const const_925:int = 13421772;
      
      private static const const_926:int = 10066329;
      
      private static const const_924:int = 10066329;
      
      public static const const_1521:int = 16777215;
      
      public static const const_1483:int = 13421772;
      
      public static const const_1427:int = 10066329;
      ...
      private var var_698:Rectangle = null;
      
      private var var_467:RoomPlaneBitmapMaskParser = null;
      
      private var var_1951:String = null;
      ...
      private var var_2084:Number = 0.0;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_698 = super.boundingRectangle;
         }
         return new Rectangle(this.var_698.x,this.var_698.y,this.var_698.width,this.var_698.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1184);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1221);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_173)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_160)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_288)
            {
               ...
               {
                  _loc13_.color = const_1483;
               }
               else
               {
                  _loc13_.color = const_1427;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1396)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_122,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
            ...
            while(_loc9_ < this.var_341.length)
            {
               ...
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_99)
               {
                  if(this.var_1624)
                  {
                     ...
                     _loc14_ = uint((_loc13_ & 255) * this.var_2215 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2216 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2218 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1554)
         {
            this.var_1554 = param1.updateId;
            this.var_698 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1284 || _loc3_.y != this.var_2088 || _loc3_.z != this.var_2085 || param1.scale != this.var_2084))
            {
               this.var_1284 = _loc3_.x;
               this.var_2088 = _loc3_.y;
               this.var_2085 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1229);
            if(_loc3_ != this.var_2214)
            {
            ...
            if(_loc4_ != this.var_1065)
            {
               this.var_1065 = _loc4_;
               this.var_2215 = this.var_1065 & 255;
               this.var_2216 = this.var_1065 >> 8 & 255;
               this.var_2218 = this.var_1065 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1188));
            if(_loc5_ != this.var_1624)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_169 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_765);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_881);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_637);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_659));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_834));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_808));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1623;
      }
         ...
         while(_loc8_ < this.var_467.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_128.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_122 || _loc3_.type == RoomPlane.const_99)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_122 || _loc3_.type == RoomPlane.const_99 && _loc12_ == RoomPlaneBitmapMaskData.const_247)
                              {
