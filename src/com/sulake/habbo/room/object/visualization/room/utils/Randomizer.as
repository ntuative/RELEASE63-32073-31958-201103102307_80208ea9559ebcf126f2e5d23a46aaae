package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1875:int = 16777216;
      ...
      private var var_2817:int = 69069;
      
      private var var_2818:int = 5;
      ...
      {
         var _loc1_:int = this.var_2817 * this.var_1824 + this.var_2818;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1825;
         this.var_1824 = _loc1_;
         return _loc1_;
      }
