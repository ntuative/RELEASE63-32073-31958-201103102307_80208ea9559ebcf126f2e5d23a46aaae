package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1617:Number = 0.0;
      
      private var var_1064:Number = 0.0;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this._width && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_464 || param1 == this.var_463)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_462;
                  while(_loc6_ < this.var_465)
                  {
               ...
               if(param2 == this.var_462 || param2 == this.var_465)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_464;
                  while(_loc8_ < this.var_463)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_839 = getFloorHeight(this.var_147);
         if(!param1)
         {
      ...
      {
         var _loc11_:* = null;
         this.addPlane(RoomPlaneData.const_160,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_288,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_1064);
         this.addPlane(RoomPlaneData.const_160,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_160,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_127) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_160,Vector3d.sum(param1,Vector3d.product(param3,-this.var_127 / param3.length)),Vector3d.product(param3,(param3.length + this.var_127) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1064 / param2.length);
               this.addPlane(RoomPlaneData.const_160,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      {
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_173,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_173,_loc13_,new Vector3d(0,0,-this.var_127),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_173,_loc13_,new Vector3d(0,0,-this.var_127),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_173,_loc13_,new Vector3d(0,0,-this.var_127),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_173,_loc13_,new Vector3d(0,0,-this.var_127),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1147;
         }
         var _loc2_:RoomPlaneData = this.var_128[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
