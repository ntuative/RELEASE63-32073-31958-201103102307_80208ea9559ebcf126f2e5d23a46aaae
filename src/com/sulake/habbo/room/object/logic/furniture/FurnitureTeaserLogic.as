      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ == this.const_2005)
         {
            if(param1.type == MouseEvent.MOUSE_UP)
            {
               if(eventDispatcher != null)
               {
                  ...
                  _loc9_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_128,_loc7_,_loc8_);
         ...
         else if(param1.type == MouseEvent.DOUBLE_CLICK)
         {
            if(eventDispatcher != null)
            {
               _loc7_ = object.getId();
               _loc8_ = object.getType();
               _loc9_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_532,_loc7_,_loc8_);
               eventDispatcher.dispatchEvent(_loc9_);
            }
         }
