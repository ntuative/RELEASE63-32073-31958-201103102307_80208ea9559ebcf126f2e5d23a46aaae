package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1021:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1184,param1.toString(),true);
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_808,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1020)
         {
            ...
            if(_loc2_ - this.var_1020 >= this.var_1540)
            {
               _loc3_ = this.var_1021;
               _loc4_ = this.var_1538;
               this.var_1020 = 0;
            }
            else
            {
               _loc7_ = this.var_1273 >> 16 & 255;
               _loc8_ = this.var_1273 >> 8 & 255;
               _loc9_ = this.var_1273 & 255;
               _loc10_ = this.var_1021 >> 16 & 255;
               _loc11_ = this.var_1021 >> 8 & 255;
               _loc12_ = this.var_1021 & 255;
               _loc13_ = (_loc2_ - this.var_1020) / this.var_1540;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1541 + (this.var_1538 - this.var_1541) * _loc13_;
               this._color = _loc3_;
               this.var_1539 = _loc4_;
            }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_861:
               param2.setString(RoomObjectVariableEnum.const_881,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_820:
               param2.setString(RoomObjectVariableEnum.const_765,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_906:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1229,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1073:
            ...
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1204:
               ...
               param2.setNumber(RoomObjectVariableEnum.const_808,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1188,int(param1.bgOnly));
         this.var_1273 = this._color;
         this.var_1541 = this.var_1539;
         this.var_1021 = _loc3_;
         this.var_1538 = _loc4_;
         this.var_1020 = getTimer();
         this.var_1540 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1437,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1419,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1540,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_173)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_160 || _loc13_ == RoomPlaneData.const_288)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
