package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_811:int = 0;
      
      protected var var_655:BitmapData;
      
      protected var var_2723:int;
      
      protected var var_1509:Boolean;
      
      protected var var_2005:Boolean;
      
      protected var var_2779:BitmapData;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2778 == FurniModel.const_45)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1419));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2004);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_794)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(this.var_2005 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2779;
               _loc5_.visible = true;
            }
            else
            {
