package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2115 = _loc2_;
         this.var_2117 = this.var_226.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this.var_17.showMakeOffer(this.var_226);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this.var_17.showBuyTokens(this.var_1923,this.var_1924);
         }
      }
      ...
      {
         if(param1 != this.var_2115 || param2 != this.var_2117)
         {
            return;
         }
         if(!this.var_17)
         ...
         this.var_17.updateAveragePrice(param3,this.var_2053);
      }
