package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1438:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_93 = this.var_619.height;
         this.var_1179 = param5;
         this.var_937 = param6;
         this.var_222 = Math.floor(this.var_1179 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1179,this.var_937);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_26 = new BitmapData(Math.max(this.var_222 * this._thumbWidth,this.var_1179),Math.max(this.var_618 * this.var_93,this.var_937),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_222 && this.var_26.height < _loc3_.y * this.var_93)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_222 - 1),this.var_93);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_222 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_93),null,null,true);
         _loc4_ = new Rectangle(0,this.var_93,this._thumbWidth * (this.var_222 - 1),this.var_26.height - this.var_93);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1438.getDrawableList();
         }
