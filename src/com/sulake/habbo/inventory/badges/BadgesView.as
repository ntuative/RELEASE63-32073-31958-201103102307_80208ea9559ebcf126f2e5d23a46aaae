package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1106:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1106 = this.var_17.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1106.procedure = this.inactiveGridEventProc;
         this.var_1107 = this.var_17.findChildByName("active_items") as IItemGridWindow;
      ...
      private function updateListViews() : void
      {
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               this.var_1106.addGridItem(_loc2_.window);
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_1106.getGridItemIndex(param1.window);
