package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1709:int = 3;
      
      private const const_1734:int = 42;
      
      private const const_1733:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_529 = param6;
         this.var_529.events.addEventListener(SongInfoReceivedEvent.const_888,this.onSongInfoReceivedEvent);
         this.var_441 = new Map();
         this.var_441.add(FurniModel.const_45,new FurniGridView(this.var_68,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_441.add(FurniModel.const_51,new FurniGridView(this.var_68,FurniModel.const_51,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_529)
            {
               this.var_529.events.removeEventListener(SongInfoReceivedEvent.const_888,this.onSongInfoReceivedEvent);
               this.var_529 = null;
            }
            this.var_653 = null;
            this._disposed = true;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_441.getValue(this.var_440);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_440);
         ...
         if(this.var_2479 == _loc2_)
         {
            return;
         }
         this.var_2479 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_441.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_441.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_441.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_440);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_390)
            {
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_989)
               {
                  _loc21_ = this.var_529.musicController.getSongInfo(_loc5_.extra);
                  if(_loc21_ != null)
                  {
                  ...
                  {
                     this.var_529.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_653.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_989)
               {
                  _loc22_ = this.var_529.musicController.getSongInfo(_loc5_.extra);
                  if(_loc22_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1733)
         {
            _loc3_ = this.const_1733;
         }
         else if(_loc3_ < this.const_1734)
         {
            _loc3_ = this.const_1734;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_64)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_339);
            }
         }
      }
      ...
      {
         if(this.var_653.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_653.indexOf(param1.id as Number) != -1)
            {
               this.var_653.splice(this.var_653.indexOf(param1.id as Number),1);
            }
         }
      }
   }
