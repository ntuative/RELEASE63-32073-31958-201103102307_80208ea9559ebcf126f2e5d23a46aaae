package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_339:String = "pets";
      
      private static const const_1319:int = 100;
      ...
      private var var_1781:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_249,this.onObjectPlaced);
         this._catalog = param7;
         this.var_529 = param8;
         this.var_605 = new Timer(const_1319,1);
         this.var_605.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2490 = XML(_loc10_.content);
         this.clearFurniList();
         this.var_17 = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_529);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_249,this.onObjectPlaced);
               }
            ...
            {
               this.var_605.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_605.stop();
               this.var_605 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            ...
            else
            {
               ...
               {
                  this.var_1781 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1781;
            }
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_77);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_390)
         {
         ...
         if(this.var_916 == null)
         {
            this.var_916 = this._windowManager.buildFromXML(this.var_2490) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_916.clone() as IWindowContainer;
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_393);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_604.add(const_45,new Array());
         this.var_604.add(const_51,new Array());
         if(this.var_17 != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_324;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_373 || _loc3_.category == FurniCategory.const_390 || _loc3_.category == FurniCategory.const_363)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1403 && param1.type == RoomEngineObjectEvent.const_249)
         {
            this.var_1403 = false;
         }
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_604.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_794)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
