package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1212:BitmapData = null;
      
      private var var_1211:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2660 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2661 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2659 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1883 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1883 > 0 && this.var_1882 >= this.var_1883)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1210;
         if(_loc1_ > this.var_2661)
         {
            ++this.var_1882;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1464 = _loc2_.imageUrl;
         this.var_2662 = _loc2_.clickUrl;
         this.var_1210 = getTimer();
         if(this.var_1464 != "")
         {
            ...
            {
               this.var_228 = new Timer(this.var_2659,1);
            ...
            this.var_228.start();
            _loc4_ = new URLRequest(this.var_1464);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_566,0,0,param1.bitmapData,this.var_2662));
            this.var_1210 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_536));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1884 = _loc2_.clickUrl;
         if(this.var_1465 != "" && this.var_1884 != "")
         {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_491,0,0,_loc4_,this.var_1884,this.var_1212,this.var_1211));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1212 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1211 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
