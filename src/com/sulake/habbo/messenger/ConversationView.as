package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1294:int = 10;
      ...
      private var var_2334:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_133 = param1;
         this.var_1678 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_61 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2334 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_935 + const_1295)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1294;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1678.enable();
         }
         else
         {
            this.var_1678.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_61.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_473.messages.length - const_935);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_663 || param3.type == Message.const_685 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_133.send(new FollowFriendMessageComposer(this.var_473.id));
      }
