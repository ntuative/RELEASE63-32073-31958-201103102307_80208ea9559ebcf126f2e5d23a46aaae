package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      public function playSendSound() : void
      {
         ...
         {
            this.var_529.playSound(HabboSoundTypesEnum.const_1031);
         }
      }
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            this.var_174.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         this.var_174.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.MESSENGER));
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_685,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function addMsg(param1:Message) : void
      {
         ...
         if(!this.var_251.isMessengerOpen())
         {
            if(this.var_529 != null)
            {
               this.var_529.playSound(HabboSoundTypesEnum.const_1015);
            }
