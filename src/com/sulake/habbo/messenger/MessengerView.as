   ...
   public class MessengerView implements IDisposable
   {
      ...
      public function openMessenger() : void
      {
         ...
         if(this.var_16 == null)
         {
            this.prepareContent();
            this.refresh();
            this.var_133.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.MESSENGER,this.var_16));
         }
         else
         {
            this.refresh();
      ...
      private function prepareContent() : void
      {
         ...
         this.var_907 = new ConversationsTabView(this.var_133,this.var_16);
         this.var_907.refresh();
         this.var_908 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_908.addEventListener(WindowKeyboardEvent.const_193,this.onMessageInput);
         this.var_1397 = new ConversationView(this.var_133,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_622,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1087,true);
      }
      ...
      private function sendMsg() : void
      {
         ...
         this.var_908.text = "";
         this.var_133.conversations.addMessageAndUpdateView(new Message(Message.const_663,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
