package com.sulake.habbo.moderation
{
   ...
   public class OpenIssuesView implements IIssueBrowserView
   {
      ...
      private var var_2100:IssueListView;
      ...
      public function OpenIssuesView(param1:IssueManager, param2:IssueBrowser, param3:IWindowContainer)
      {
         ...
         this.var_2100 = new IssueListView(param1,param2,_loc4_,"open_issues_list_item_xml");
      }
      ...
      {
         var _loc1_:Array = this._issueManager.getBundles(IssueManager.const_990);
         this.var_2100.update(_loc1_);
      }
   }
}
