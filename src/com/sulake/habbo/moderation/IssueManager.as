package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_990:String = "issue_bundle_open";
      
      public static const const_856:String = "issue_bundle_my";
      
      public static const const_1209:String = "issue_bundle_picked";
      
      public static const const_1495:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_648 = new IssueBrowser(this,this.var_66.windowManager,this.var_66.assets);
         this.var_1229 = [];
         this.var_1230 = [];
         this.var_988 = new Map();
         this.var_2722 = parseInt(this.var_66.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1927 = new Timer(const_1495,0);
         this.var_1927.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1927.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1229 = this.var_1229.concat(_loc4_.getIssueIds());
      }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1230 = this.var_1230.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_66.soundManager.playSound(HabboSoundTypesEnum.const_1009);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_987.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_987.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1655)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_105)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_987.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            this.var_987.add(param1.issueId,_loc2_);
         ...
         if(this.var_1229.indexOf(param1.issueId) != -1)
         {
         ...
         {
            _loc6_ = this.getBundles(const_856);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1230.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      {
         var _loc2_:IssueHandler = this.var_988.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_988.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_987.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_105.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_988.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_988.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_988.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
