package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1195:IDropMenuWindow;
      ...
      private var var_954:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1193 = IButtonWindow(this.var_34.getXmlWindow("modact_offence"));
         this.var_1194 = IButtonWindow(this.var_34.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1856;
         ...
         this.var_1195 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1195);
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            this._frame.findChildByName("offence_txt").caption = this.var_954.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_953 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_953.offences,this.var_1193,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_34.initMsg.offenceCategories,this.var_1194,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.connection.send(new ModAlertMessageComposer(this.var_1447,this.var_515.text,this.var_1448));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_953 = this.var_34.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_954 = this.var_953.offences[_loc3_];
         this.var_515.text = this.var_954.msg;
         this.var_620 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.connection.send(new ModKickMessageComposer(this.var_1447,this.var_515.text,this.var_1448));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1195.selection < 0)
         {
            this.var_34.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_34.connection.send(new ModBanMessageComposer(this.var_1447,this.var_515.text,this.getBanLength(),this.var_1448));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1195.selection;
