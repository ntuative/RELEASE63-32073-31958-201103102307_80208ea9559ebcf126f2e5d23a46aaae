package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_773:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2628 = param2.pickerUserId;
         this.var_2649 = param2.pickerUserName;
         this.var_1343 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1201 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1202;
         }
         if(this.var_773 == null || param1.timeStamp < this.var_773.timeStamp)
         {
            this.var_773 = param1;
         }
         if(this.var_774 == null || param1.priority > this.var_774.timeStamp)
         {
            this.var_774 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1201 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1202;
            }
            if(this.var_773 == _loc2_)
            {
               this.var_773 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_774;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_773;
         if(_loc2_ == null)
         {
