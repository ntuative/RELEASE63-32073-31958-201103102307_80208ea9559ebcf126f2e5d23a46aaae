package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      {
         return this.getUserDataByType(param1,const_1303);
      }
      
      public function getUserDataByType(param1:int, param2:int) : IUserData
      {
         var _loc3_:* = null;
         var _loc4_:Map = this.var_738.getValue(param2);
         if(_loc4_ != null)
         {
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_899.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      public function setUserData(param1:IUserData) : void
      {
         ...
         var _loc2_:Map = this.var_738.getValue(param1.type);
         if(_loc2_ == null)
         {
            _loc2_ = new Map();
            this.var_738.add(param1.type,_loc2_);
         }
      ...
      public function removeUserDataByIndex(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_738.getValue(_loc2_.type);
            if(_loc3_ != null)
            {
      ...
      {
         this.var_899.remove(param1);
         this.var_899.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1304);
      }
