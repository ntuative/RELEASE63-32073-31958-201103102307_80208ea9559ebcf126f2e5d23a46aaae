package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1629)
         {
            this.gotoRoom(this.var_2236,this.var_2237,this.var_1630);
            this.var_1629 = false;
            this.var_1630 = "";
         }
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1113:
                  break;
               case RoomSessionHandler.const_1123:
                  break;
               case RoomSessionHandler.const_758:
      ...
      public function disposeSession(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_102,_loc4_));
            _loc4_.dispose();
         }
      }
