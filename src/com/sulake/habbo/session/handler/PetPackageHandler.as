package com.sulake.habbo.session.handler
{
   ...
   public class PetPackageHandler extends BaseHandler
   {
      ...
      private function onOpenPetPackageResult(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionPetPackageEvent(RoomSessionPetPackageEvent.const_568,_loc3_,_loc2_.objectId,-1,-1,"",_loc2_.nameValidationStatus));
         }
      }
   }
}
