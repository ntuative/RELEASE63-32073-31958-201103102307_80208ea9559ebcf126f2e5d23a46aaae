package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2144:FriendListLookAndFeel;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_829)
         {
            this.var_829.release(new IIDHabboNotifications());
            this.var_829 = null;
         }
         if(this.var_174)
         {
         ...
         if(this.var_695)
         {
            this.var_695.release(new IIDSessionDataManager());
            this.var_695 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1589 = new OpenedToWebPopup(this);
         }
         this.var_1589.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_336.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_174.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_323,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1055.createAvatarImage(param1,AvatarScaleType.const_91,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_174 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_829 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_336 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_97.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_97.addCategory(new FriendCategory(FriendCategory.const_1137,this.getText("friendlist.friends")));
         this.var_97.addCategory(new FriendCategory(FriendCategory.const_359,this.getText("friendlist.friends.offlinecaption")));
         ...
         this.var_174.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_97.findCategory(FriendCategory.const_359);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_336.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_336.addRequest(new FriendRequest(_loc3_));
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_336.addRequestAndUpdateView(_loc3_);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1588.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         if(!this.var_695 || !this.var_336)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_695.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_336.vipLimit;
         }
         else if(this.var_695.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_42))
         {
            _loc2_ = this.var_336.clubLimit;
         }
         if(_loc2_ > this.var_336.limit)
         {
            this.var_336.limit = _loc2_;
         }
      }
