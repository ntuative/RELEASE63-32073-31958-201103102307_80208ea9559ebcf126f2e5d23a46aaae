package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1723:String = "no_reqs_info";
      ...
      {
         this.var_1822 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1821 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1821.procedure = this.onDismissAllButtonClick;
         this.var_1822.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_399 && _loc4_.state != FriendRequest.const_337)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1822,_loc1_);
         this.setEnabled(this.var_1821,_loc1_);
      }
