package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_419:uint = 3;
      
      private static const const_1377:uint = 1;
      ...
      private var var_989:IWindowRenderer;
      
      private var var_915:ISkinContainer;
      
      private var var_274:Array;
      
      private var var_1492:IEventDispatcher;
      
      private var var_1235:Boolean = false;
      
      private var var_1941:ProfilerOutput;
      
      private var var_1491:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_915 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_989 = new WindowRenderer(this.var_915);
         this._windowContextArray = new Array(const_419);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_419)
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_989,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_260 = this._windowContextArray[const_1377];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1941)
            {
               this.var_1941 = new ProfilerOutput(context,this,this.var_989);
            }
            this.var_1941.profiler = _loc3_;
            this.var_1491 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1491);
            this.var_1493 = new ProfilerAgentTask("Redraw","Window rasterizer");
      ...
      {
         return this.var_260.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_260.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_915.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_260.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_385.length > 0)
         {
            this.var_1492.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_419 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1492.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_419)
         {
         ...
         if(WindowContext.var_385.length > 0)
         {
            WindowContext.var_385.flush();
         }
         MouseCursorControl.change();
         this.var_1492.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1457,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1635,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1582,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1509,param2.name + ": " + param2.toString());
            }
         }
      }
