package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2828:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2828 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_371:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_79,this.var_158,this.var_2697++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_79,this);
               break;
            case RoomWidgetEnum.const_470:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_79,this.var_158,this._catalog);
               break;
            case RoomWidgetEnum.const_542:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_79,events,this.var_158);
               break;
            ...
            case RoomWidgetEnum.const_445:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_79,this.var_158,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_503:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_79,this.var_158);
               break;
            case RoomWidgetEnum.const_690:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_79,this.var_158);
               break;
            case RoomWidgetEnum.const_121:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_79,this.var_158);
               break;
