package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2050 = param1.objectCategory;
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_663 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         this.var_663 = _loc4_;
         this.var_663.offset(100,100);
         var _loc6_:IWindow = this.var_663.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_364,param1,this.var_339,this.var_2050,this._roomId,this._roomCategory,_loc5_);
