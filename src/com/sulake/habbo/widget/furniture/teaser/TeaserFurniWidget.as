package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1716:int = 2;
      
      private const const_1714:int = 3;
      
      private const const_1717:int = 4;
      ...
      private const const_1991:int = 3;
      
      private const const_1994:int = 4;
      
      private const const_1996:int = 5;
      
      private const const_1718:String = "deco_img";
      
      private const const_1713:String = "dialog_bg";
      
      private const const_1993:String = "%campaign%_dialog_bg.png";
      
      private const const_330:String = "%campaign%_gift_package.png";
      
      private const const_1995:String = "%campaign%_gift_content.png";
      
      private const const_1997:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1404 = this.var_158.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1404 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1407.length)
         {
            _loc2_ = this.var_1407.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_158 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_541,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_617,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_541,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_541:
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_695:
               ...
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_617:
         ...
         if(this._window && (this.var_1406 != _loc2_ || _loc3_ != this.var_181))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1406)
            {
               ...
               case this.const_1715:
                  if(this.var_386 == this.const_1989)
                  {
                  ...
                  else if(this.var_386 == this.const_1990)
                  {
                  ...
                  else if(this.var_386 == this.const_1992)
                  {
                  ...
                  else if(this.var_386 == this.const_1991)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_386 == this.const_1994)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_181,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_386 == this.const_1996)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_1993.replace("%campaign%",this.var_181);
            this.setDecoImage(_loc5_,this.const_1713);
            _loc2_ = _loc2_.replace("%campaign%",this.var_181);
            this.setDecoImage(_loc2_,this.const_1718);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_832);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1405 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1405 == 1 ? "null" : InventoryCategory.const_140);
            }
         }
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1407.push(new ImageDownloader(this,_assets,this.var_181,this.var_1404,param1,param2));
            return;
         }
