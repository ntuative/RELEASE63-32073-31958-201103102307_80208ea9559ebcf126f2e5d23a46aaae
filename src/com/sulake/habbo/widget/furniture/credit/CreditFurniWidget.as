package com.sulake.habbo.widget.furniture.credit
{
   ...
   public class CreditFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetCreditFurniUpdateEvent.const_816,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetCreditFurniUpdateEvent.const_816,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetCreditFurniUpdateEvent) : void
      {
         ...
         this.var_1525 = param1.creditValue;
         this.showInterface();
      }
      ...
      private function showInterface() : void
      {
         ...
         windowManager.registerLocalizationParameter("widgets.furniture.credit.redeem.value","value",String(this.var_1525));
         ...
         this._window = windowManager.createWindow("creditfurniui_container","",HabboWindowType.const_62,HabboWindowStyle.const_32,0 | 0,new Rectangle(const_1239,const_1238,2,2),null,0) as IWindowContainer;
      ...
      private function sendRedeemMessage() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetCreditFurniRedeemMessage(RoomWidgetCreditFurniRedeemMessage.const_730,this.var_1018);
