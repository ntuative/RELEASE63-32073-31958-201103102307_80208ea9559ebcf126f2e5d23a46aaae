package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_555:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_62,HabboWindowStyle.const_32,0 | 0,new Rectangle(const_1239,const_1238,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_555 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         ...
         this.var_270 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_270.numTabItems)
         {
            _loc6_ = this.var_270.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1294 = _loc2_.light;
         if(this.var_399 != null)
         {
            this.var_399.setValue(this.var_1294);
         }
         this.var_483 = this.colors.indexOf(_loc2_.color);
         if(this.var_555 != null)
         {
            this.var_555.setSelectedColorIndex(this.var_483);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_270.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_270.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_270.selector.getSelected();
         return this.var_270.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1293 = XML(_loc1_.content);
         return this.var_1293;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_555 != null)
         {
            this.var_555.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
