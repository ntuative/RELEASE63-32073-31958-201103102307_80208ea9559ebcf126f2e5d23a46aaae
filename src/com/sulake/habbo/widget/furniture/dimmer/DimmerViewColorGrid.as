package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      {
         if(this.var_17 == null || this.var_484 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in this.colors)
         {
            ...
            _loc3_.width = this.var_589.width;
            _loc3_.height = this.var_589.height;
            this.var_484.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_589.width,this.var_589.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_589,this.var_589.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1130.width,this.var_1130.height,true,0);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_589 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_button"));
         this.var_1130 = BitmapData(_loc3_.content);
