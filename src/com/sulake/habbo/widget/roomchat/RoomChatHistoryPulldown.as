package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_980:int = 150;
      
      private static const const_979:int = 250;
      ...
      private var var_2689:BitmapData;
      
      private var var_1893:BitmapData;
      
      private var var_1894:BitmapData;
      
      private var var_2688:BitmapData;
      
      private var var_2691:BitmapData;
      
      private var var_2686:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_40 = param3;
         this.var_2687 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1892 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2689 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1893 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1894 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2688 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2691 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_78 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_323,HabboWindowStyle.const_32,HabboWindowParam.const_60,new Rectangle(0,0,param3.width,param3.height - const_86),null,0,0) as IBitmapWrapperWindow;
         this.var_40.addChild(this.var_78);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_62,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,this.var_40.height - const_86,param3.width,const_86),null,0) as IWindowContainer;
         this.var_40.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_518,HabboWindowStyle.const_43,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_86),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_450:
               this.var_78.blend += param1 / const_979;
               this._window.blend += param1 / const_979;
               ...
               break;
            case const_931:
               this.var_78.blend -= param1 / const_980;
               this._window.blend -= param1 / const_980;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_40.width - this.var_2686;
         }
         if(this.var_78 != null)
         {
            this.var_78.rectangle = this.var_40.rectangle;
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2690 == this._window.width)
         {
            return;
         }
         this.var_2690 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2689;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1893;
            _loc2_.disposesBitmap = false;
            this.var_2686 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2687,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1892,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1892,_loc9_);
         ...
         this.var_78.bitmap = this.var_2691;
