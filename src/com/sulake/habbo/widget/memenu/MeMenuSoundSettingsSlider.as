package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1171:MeMenuSoundSettingsView;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_1171.volume);
      }
      ...
      {
         return param1 / this.var_1670 * (this.var_1092 - this._minValue) + this._minValue;
      }
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1171.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_715 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_715.width,this.var_715.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_715,this.var_715.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_714 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_714.width,this.var_714.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_714,this.var_714.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1670 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
