package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_965:MeMenuSoundSettingsSlider;
      ...
      public function updateSettings(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_965 != null)
         {
            this.var_965.setValue(this._volume);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1876 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this.var_965 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_892));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1876);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1879);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_901);
         }
