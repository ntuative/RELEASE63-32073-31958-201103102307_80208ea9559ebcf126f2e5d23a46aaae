package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2002:int = 1000;
      ...
      private var var_765:ITextWindow;
      
      private var var_195:Timer;
      
      private var var_950:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_195 = new Timer(this.const_2002);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_182.isActive)
         {
            ...
            this.var_949.width = _loc2_ * this.var_295;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_765 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_765 == null)
            {
               return;
            }
         ...
         if(!this.var_182.isActive)
         {
            this.var_765.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_765.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_765.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_950 = this._window.findChildByName("effect_hilite");
         ...
         if(this.var_949 != null)
         {
            this.var_295 = this.var_949.width;
            this.var_195.start();
            this.onUpdate();
         }
