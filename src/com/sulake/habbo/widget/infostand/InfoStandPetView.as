package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2019:int = 152;
      
      private const const_2013:int = 16;
      
      private const const_1371:int = 4;
      
      private const const_2018:uint = 14342874;
      
      private const const_2009:uint = 3815994;
      
      private const const_2015:uint = 2085362;
      
      private const const_2020:uint = 39616;
      
      private const const_2010:uint = 10513106;
      
      private const const_2012:uint = 8734654;
      
      private const const_2017:uint = 9094430;
      
      private const const_2011:uint = 6200576;
      
      private const const_2014:String = "happiness";
      
      private const const_2021:String = "experience";
      
      private const const_2016:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_202 == null || this.var_67 == null)
         {
            return;
         }
         ...
         this.var_202.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_202.width,this.var_67.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_202.width < this.var_67.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2014,param1.nutrition,param1.nutritionMax,this.const_2020,this.const_2015);
         this.updateStateElement(this.const_2021,param1.experience,param1.method_1,this.const_2012,this.const_2010);
         this.updateStateElement(this.const_2016,param1.energy,param1.energyMax,this.const_2011,this.const_2017);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2019,this.const_2013,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2018);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2009);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1371,_loc7_.width - 2,_loc7_.height - 2 - this.const_1371);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1371);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_53 = this.var_202.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_201 && this.var_201.getPetId() == this.var_526)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_421,this._widget.petData.ownerId);
