package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_998 = this.var_202.findChildByTag("catalog");
         if(this.var_998 != null)
         {
            this.var_998.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_53.addListItem(this.var_998);
            }
            this.var_998.visible = param1;
         }
         else
         {
            this.var_53.removeListItem(this.var_998);
         }
      }
   }
}
