package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_130:IBorderWindow;
      
      private var var_2360:int;
      
      private const const_938:int = 5;
      
      private const const_1704:int = 39;
      
      private const const_1705:int = 7829367;
      
      private const const_1703:int = 16777215;
      
      private const const_1984:int = 2000;
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_130.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_130.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_130.x = _loc5_.left - this.var_130.width;
         this.var_130.y = _loc5_.top + (_loc5_.height - this.var_130.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_130.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_130.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_130.x = _loc7_.left - this.var_130.width;
         this.var_130.y = _loc7_.top + (_loc7_.height - this.var_130.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_130 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_130 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_346,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_346,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1169:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1177:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2360 > this.const_1984 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2360 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1705;
            if(_loc3_.length >= this.const_1704)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1704 - 1);
            }
         }
      }
