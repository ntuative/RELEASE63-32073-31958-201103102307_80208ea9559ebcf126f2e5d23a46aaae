package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1035:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1034 = 0;
         this.var_1035 = param2.rectangle.clone();
         this.var_1035.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1035.width)
         {
            return false;
         }
         if(this.var_1034 + param1.height > this.var_1035.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1035.width)
         {
            this._offsetX = 0;
            this.var_1034 += param1.height + this.const_1977;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1034);
      ...
      {
         var _loc2_:* = null;
         if(this.var_1336 != null && this.var_1336.indexOf(param1) != -1)
         {
