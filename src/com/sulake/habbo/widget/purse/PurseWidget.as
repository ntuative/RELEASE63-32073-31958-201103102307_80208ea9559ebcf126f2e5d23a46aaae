package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      {
         this.var_2542 = param1.balance;
         if(this.var_17)
         {
            this.var_17.findChildByName("credits").caption = this.var_2542.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_2704 = param1.balance;
         if(this.var_17)
         {
            this.var_17.findChildByName("pixels").caption = this.var_2704.toString();
         }
      }
