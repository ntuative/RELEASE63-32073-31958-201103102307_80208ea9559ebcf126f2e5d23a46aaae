package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1349:int = 11;
      
      private static const const_607:int = 18;
      
      private static const const_965:int = 16;
      
      private static const const_1350:int = 20;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1184 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2596 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_369 = new Timer(1000,1);
         this.var_369.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_424 = new Timer(10000,1);
         this.var_424.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_424.reset();
            this.var_424.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_424 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_193,this.windowKeyEventProcessor);
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_607 + const_965;
         _loc1_.x = const_607;
         _loc1_.y = const_1349;
      }
      ...
      {
         this.var_295 = param1 - (const_607 + const_965);
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1184 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_503 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1350);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_503.length + 1)
            {
               _loc2_.text = "";
            }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_621);
