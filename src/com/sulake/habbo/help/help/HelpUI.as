package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103102302));
         this.var_174 = param5;
         this.var_116 = new Map();
         this.var_116.add(HabboHelpViewEnum.const_1501,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_180,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_437,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_291,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_213,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_384,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_626,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_253,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_116.add(HabboHelpViewEnum.const_1227,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_116.add(HabboHelpViewEnum.const_1134,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_759,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_474.length == 0 || param1 != this.var_349)
            {
               this.var_474.push(this.var_349);
            }
         }
         this.var_349 = param1;
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_174.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_116.getValue(HabboHelpViewEnum.const_180) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_577));
      }
      ...
      {
         return this.var_116.getValue(this.var_349);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2070 = this._window.width - _loc4_.width;
         this.var_2072 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2072;
         this._window.width = _loc1_.width + this.var_2070;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_474.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_349 == HabboHelpViewEnum.const_180)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_349 == HabboHelpViewEnum.const_180 || this.var_474.length == 0)
         {
            return;
         }
         if(this.var_350 == null)
