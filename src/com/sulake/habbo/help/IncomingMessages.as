   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_176)
            {
         ...
         this._component.tellUI(HabboHelpViewEnum.const_759);
      }
      ...
      {
         this._component.showUI(HabboHelpViewEnum.const_384);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this._component.showUI(HabboHelpViewEnum.const_1181);
         this._component.tellUI(HabboHelpViewEnum.const_1181,_loc5_);
      }
