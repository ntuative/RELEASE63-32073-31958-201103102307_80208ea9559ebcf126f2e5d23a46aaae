package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1385:uint = 13232628;
      
      private static var var_1743:uint = 11129827;
      ...
      private var var_1132:NameSuggestionListRenderer;
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_803:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1000 || param1 == ChangeUserNameResultMessageEvent.var_999)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1132 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1132.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1385;
