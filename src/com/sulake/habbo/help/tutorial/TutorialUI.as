package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      private var var_331:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_577,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_583,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_578,this.onTaskDoneEvent);
         if(this.var_34.sessionDataManager != null)
         {
            this.var_34.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_285,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1028 && this.var_1027 && this.var_1283;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_577,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_583,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_578,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
               this.var_34.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_285,this.onFigureUpdate);
            }
            this.var_34 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_577:
               this.var_1283 = true;
               if(this.var_44 != null && this.var_44.id == const_550)
               {
                  this.showView(const_88);
               }
               break;
            case HabboHelpTutorialEvent.const_583:
               if(this.var_44 != null && this.var_44.id == const_391)
               {
                  this.var_1551 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2070 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_276:
               ...
               if(this.var_331 == null)
               {
                  this.var_331 = new NameChangeView(this);
               }
               this.var_331.showMainView();
               this.prepareForTutorial();
               break;
            case const_391:
         ...
         this._window.height = _loc2_.height + this.var_2072;
         this._window.width = _loc2_.width + this.var_2070;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_44 != null && (this.var_44.id == const_276 || this.var_44.id == const_88))
         {
            this.showView(const_88);
         }
      }
      ...
      {
         this.var_1028 = true;
         if(this.var_44 != null && (this.var_44.id == const_391 || this.var_44.id == const_88))
         {
            this.showView(const_88);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_532)
         {
            this.var_1027 = true;
         ...
         {
            this.var_331.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_532)
         {
            this.var_331.checkedName = _loc2_.name;
         }
         else
         {
            this.var_331.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
