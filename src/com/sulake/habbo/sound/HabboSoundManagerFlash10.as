package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_830:TraxSequencer;
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_828.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1009:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1594:
               ...
               case HabboSoundTypesEnum.const_984:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1665:
            ...
            this.var_828.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_549.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_671.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_671,events);
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_829.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_829 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_185 == null || this._connection == null || this._roomEngine == null || this.var_457 != null)
         {
            return;
         }
         this.var_457 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_549.getValue(_loc2_);
         ...
         this.var_549.remove(_loc2_);
         this.var_671.add(_loc3_,_loc6_);
         if(this.var_549.length == 0 && this.var_670 != -1)
         {
            this.var_830.ready = true;
            _loc7_ = this.var_670;
            this.var_670 = -1;
            this.var_830 = null;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1037,_loc7_));
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_457.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1384,this.var_670));
         this.var_670 = -1;
         this.var_830 = null;
      }
      ...
      {
         this._volume = param1;
         this.var_457.updateVolume(this._volume);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         this.var_174.events.dispatchEvent(_loc2_);
      }
   }
}
