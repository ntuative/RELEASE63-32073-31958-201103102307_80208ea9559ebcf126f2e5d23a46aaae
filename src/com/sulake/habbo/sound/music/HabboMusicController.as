package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private var var_529:HabboSoundManagerFlash10;
      ...
      private var var_1735:RoomItemPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_1735 = new RoomItemPlayListController(param1,this,param2,param3,param4);
         this._connection.addMessageEvent(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_1122 = new Timer(1000);
         this.var_1122.start();
         this.var_1122.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
      }
      ...
      {
         return this.var_1735 as IPlayListController;
      }
      ...
      public function playSong(param1:int, param2:int, param3:Number = 0) : Boolean
      {
         ...
         var _loc4_:SongDataEntry = this.var_178.getValue(param1) as SongDataEntry;
         if(_loc4_ == null)
         {
            this.requestSongInfo(param1);
            _loc6_ = new Date();
            this.var_890.add(param1,_loc6_.getTime());
            this.var_892.add(param1,param3);
            return false;
         }
         this.var_892[param1] = param3;
         if(_loc4_.soundObject == null)
         {
            this.var_890[param1] = _loc6_.getTime();
            this.var_892[param1] = param3;
            _loc4_.soundObject = this.var_529.loadTraxSong(_loc4_.id,_loc4_.songData);
         }
         ...
         if(param2 >= this.var_1123)
         {
            for each(_loc7_ in this.var_194.getValues())
            {
               if(_loc7_ != param1)
               {
                  _loc8_ = this.var_178.getValue(_loc7_) as SongDataEntry;
      ...
      {
         var _loc4_:int = 0;
         var _loc2_:SongDataEntry = this.var_178.getValue(param1) as SongDataEntry;
         if(_loc2_ != null)
         {
         ...
         if(_loc3_ != -1)
         {
            ...
            this.var_1123 = this.getTopPriority();
         }
      }
      ...
      public function stop(param1:int = 10) : void
      {
         ...
         while(_loc2_ < this.var_194.length)
         {
            ...
            if(_loc3_ <= param1)
            {
               ...
               _loc5_ = this.var_178.getValue(_loc4_) as SongDataEntry;
               if(_loc5_ != null)
               {
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         {
            _loc3_ = this.var_178.getValue(_loc2_) as SongDataEntry;
            if(_loc3_ != null)
            {
      ...
      {
         var _loc2_:int = this.var_194[this.var_1123];
         Logger.log("Song loaded : " + param1);
         if(param1 == _loc2_)
         {
            this.playSongObject(param1,this.var_892[param1]);
         }
      }
      ...
      {
         if(this.var_408.indexOf(param1) == -1)
         {
            this.var_408.push(param1);
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         var _loc2_:int = this.var_408[0];
         if(this.var_178.getValue(_loc2_) != null)
         {
            this.var_408.pop();
            return;
         }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:* = this.var_178.getValue(_loc3_.id) == null;
         var _loc5_:* = this.var_891.indexOf(_loc3_.id) == -1;
         this.var_408.splice(this.var_408.indexOf(_loc3_.id),1);
         if(!_loc5_)
         {
            this.var_891.splice(this.var_891.indexOf(_loc3_.id),1);
         }
         if(_loc4_)
         {
            if(_loc5_)
            {
               _loc6_ = this.var_529.loadTraxSong(_loc3_.id,_loc3_.data);
               if(_loc6_ == null)
               {
                  return;
               }
               _loc7_ = new SongDataEntry(_loc3_.id,_loc3_.length,_loc3_.name,_loc3_.author,_loc6_);
               this.var_178.add(_loc3_.id,_loc7_);
               _loc8_ = this.var_194[this.var_1123];
               if(_loc6_.ready && _loc3_.id == _loc8_)
               {
                  this.playSongObject(_loc8_,this.var_892[_loc8_]);
               }
            }
            else
            {
               ...
               this.var_178.add(_loc3_.id,_loc9_);
               this._events.dispatchEvent(new SongInfoReceivedEvent(SongInfoReceivedEvent.const_888,_loc3_.id));
            }
         }
      ...
      private function playSongObject(param1:int, param2:Number = -1) : Boolean
      {
         ...
         var _loc3_:SongDataEntry = this.var_178.getValue(param1) as SongDataEntry;
         if(_loc3_ == null)
         {
         ...
         _loc4_.volume = this.var_529.volume;
         if(param2 != const_1554)
         {
            _loc4_.position = param2;
            if(this.var_890.getKeys().indexOf(param1) != -1)
            {
               _loc6_ = new Date();
               _loc7_ = (_loc6_.getTime() - this.var_890[param1]) / 1000;
         ...
         {
            this.var_529.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
