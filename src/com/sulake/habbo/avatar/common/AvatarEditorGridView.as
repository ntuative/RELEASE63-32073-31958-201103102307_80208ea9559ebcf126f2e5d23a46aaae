package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      private var var_610:IItemGridWindow;
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(this.var_17 != null)
         {
            this.var_610 = this.var_17.findChildByName("part_thumbs") as IItemGridWindow;
            this.var_494 = new Array();
            this.var_494.push(this.var_17.findChildByName("palette0") as IItemGridWindow);
            this.var_494.push(this.var_17.findChildByName("palette1") as IItemGridWindow);
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = this.var_68.getCategoryData(this.var_1416);
         if(!_loc1_)
         {
            return;
         }
         this.var_610.removeGridItems();
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               this.var_610.addGridItem(_loc2_.view);
      ...
      {
         var _loc3_:IWindow = this.var_610.getGridItemAt(param1);
         if(!_loc3_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_610.getGridItemIndex(param1.window);
            this.var_68.selectPart(this.var_1416,_loc3_);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            while(_loc7_ < this.const_1356)
            {
               if(this.var_494.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     this.var_68.selectColor(this.var_1416,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
