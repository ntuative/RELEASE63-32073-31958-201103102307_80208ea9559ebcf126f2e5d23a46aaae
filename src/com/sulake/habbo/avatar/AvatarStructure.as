package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_406:AvatarRenderManager;
      ...
      private var var_300:AnimationData;
      
      private var var_793:AnimationManager;
      
      private var var_842:ActionDefinition;
      
      private var var_525:String;
      
      private var var_1481:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         ...
         this.var_300 = new AnimationData();
         this.var_793 = new AnimationManager();
         this.var_525 = param2;
      ...
      {
         this.var_1481.method_11(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_525);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_525);
            return;
         }
         this.var_985 = new AvatarActionManager(param1,this.var_525,param2);
         this.var_842 = this.var_985.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_525);
            return false;
         }
         if(this.var_437.parse(param1))
         {
            if(this.var_525 == AvatarType.const_113)
            {
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_525);
            return false;
         }
         return this.var_300.parse(param1);
      }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_525);
            return false;
         }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_793.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      {
         return this.var_793.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_793.getAnimation(param1) as Animation;
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_644[param1] = new Dictionary();
         }
         if(this.var_644[param1][param2])
         {
            return this.var_644[param1][param2];
         }
         this.var_644[param1][param2] = this.var_378.getMandatorySetTypeIds(param1,param2);
         return this.var_644[param1][param2];
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_793.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
         ...
         else
         {
            ...
            {
               _loc5_ = this._geometry.method_6(_loc4_,_loc13_);
               if(_loc5_ != null)
               {
                  if(_loc3_.indexOf(_loc5_.id) == -1)
                  {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1584[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc13_:* = [0];
         var _loc14_:AnimationAction = this.var_300.getAction(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc23_ = param3.definition.state + "." + param3.actionParameter;
            _loc9_ = this.var_793.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               {
                  _loc41_ = this._geometry.method_6(param4,_loc11_);
      ...
      {
         return this.var_1481.getOffset(param1,param2,param3,param4,param5,param6);
      }
