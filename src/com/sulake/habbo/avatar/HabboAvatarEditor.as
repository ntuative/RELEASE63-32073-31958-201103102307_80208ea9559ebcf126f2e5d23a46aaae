package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1355:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1354:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_695:ISessionDataManager;
      ...
      private var var_946:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_188)
         {
            ...
            this.var_624["null"] = new FigureData(this);
            this.var_624["null"] = new FigureData(this);
            _loc2_ = this.var_624["null"];
            _loc3_ = this.var_624["null"];
            _loc2_.loadAvatarData(const_1355,FigureData.const_78);
            _loc3_.loadAvatarData(const_1354,FigureData.FEMALE);
            this.var_97 = new Map();
            this.var_507 = new Map();
            this.var_97.add(AvatarEditorFigureCategory.const_883,new BodyModel(this));
            this.var_97.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
            this.var_97.add(AvatarEditorFigureCategory.const_220,new TorsoModel(this));
            this.var_97.add(AvatarEditorFigureCategory.const_767,new LegsModel(this));
            ...
            this.var_507.add(AvatarEditorSideCategory.const_105,new WardrobeModel(this));
            this.var_507.add(AvatarEditorSideCategory.const_480,new ClubPromoModel(this));
            this.var_188 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_624[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_946.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_946.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_260 == null)
            {
               this.var_260 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_62,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_260.addChild(this.var_17.window);
               if(param5)
               {
                  this.var_260.center();
               }
            ...
            this.var_260.visible = !this.var_260.visible;
         }
         this.var_17.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_883);
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_695 = param2 as ISessionDataManager;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_506 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_946 = this.var_506.getFigureData(AvatarType.const_113);
      ...
      {
         return this.var_624[this.var_990];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1442 != null)
         {
            ...
            this.var_1442.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1842;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1185 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1356)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1507.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_506.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_506.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1239.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1185 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1239.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1185 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_507.getValue(AvatarEditorSideCategory.const_105);
      }
