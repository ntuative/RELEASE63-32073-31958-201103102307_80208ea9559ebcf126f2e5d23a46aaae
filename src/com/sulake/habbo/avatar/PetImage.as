package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_535:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_52)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1305);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_559);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_559);
                  _loc20_ = this.var_89;
                  _loc21_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_559);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_559);
                  _loc21_ = this.var_89;
                  _loc22_ = 1;
                  switch(this.var_89)
                  {
         ...
         switch(param1)
         {
            case AvatarAction.const_383:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1612:
                  case AvatarAction.const_1656:
                  case AvatarAction.const_1063:
                  case AvatarAction.const_1128:
                  case AvatarAction.const_1637:
      ...
      private function sortActions() : void
      {
         ...
         this.var_1304 = this._structure.sortActions(this.var_322);
         ...
         {
            this.var_737 = this._structure.getCanvasOffsets(this.var_1304,this._scale,this.var_89);
         }
      }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1067 = _loc4_.id;
                     this.var_1602 = _loc4_.breed;
                     break;
                  }
               }
            }
