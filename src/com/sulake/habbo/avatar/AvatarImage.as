package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1253:String = "Default";
      
      private static const const_1254:int = 2;
      
      private static const const_1255:String = AvatarSetType.const_36;
      ...
      protected var var_535:IAvatarDataContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1255,const_1254);
         this.var_322 = new Array();
         this.var_842 = new ActiveActionData(AvatarAction.const_345);
         this.var_842.definition = this._structure.getActionDefinition(const_1253);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_665)
         {
            ...
            if(this.var_697)
            {
               for each(_loc2_ in this.var_697)
               {
                  _loc2_.dispose();
               }
      ...
      public function method_10() : IAvatarFigureContainer
      {
         return this._figure;
      }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_559,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_241.length == 1 && this.var_89 == this.var_2002)
         {
            return this.var_89 + this.var_460 + this.var_559 % 4;
         }
         if(this.var_241.length == 2)
         {
            for each(_loc1_ in this.var_241)
            {
               ...
               {
                  return this.var_89 + this.var_460 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_559 % 11;
                  return this.var_89 + "_" + this.var_2002 + this.var_460 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2174 || param2 != this.var_2173 || param1 != this.var_2175)
         {
            this.var_2174 = param3;
            this.var_2173 = param2;
            this.var_2175 = param1;
            this.var_1607 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_559);
         ...
         {
            if(this.var_535.paletteIsGrayscale)
            {
               ...
               this.var_45 = _loc13_;
               this.var_45.paletteMap(this.var_45,this.var_45.rect,new Point(0,0),this.var_535.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_559);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_322.push(new ActiveActionData(param1,param2,this.var_559));
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_460 = "";
         this.var_241 = this._structure.sortActions(this.var_322);
         if(this.var_241 == null)
         {
            this.var_737 = new Array(0,0,0);
            if(this.var_1307 != "")
            {
               _loc1_ = true;
               this.var_1307 = "";
         ...
         {
            this.var_737 = this._structure.getCanvasOffsets(this.var_241,this._scale,this.var_89);
            ...
            if(this.var_1307 != this.var_460)
            {
               _loc1_ = true;
               this.var_1307 = this.var_460;
            }
         }
         this.var_1303 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1601 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_535 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_302 || _loc1_.actionType == AvatarAction.const_251 || _loc1_.actionType == AvatarAction.const_347)
               {
                  this.var_843 = true;
               }
            }
