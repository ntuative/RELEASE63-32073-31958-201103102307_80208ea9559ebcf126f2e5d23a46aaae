package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit, IAvatarImageListener
   {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IAvatarImage = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_91,this.var_990,this);
         if(_loc1_)
         {
            _loc1_.setDirection(AvatarSetType.const_36,int(FigureData.const_627));
