package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1239:IWindowContainer;
      
      public static var var_1507:IWindowContainer;
      ...
      private var var_490:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1144 = [];
         this.var_1396 = [AvatarEditorFigureCategory.const_883,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_220,AvatarEditorFigureCategory.const_767,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_105];
         super();
         ...
         if(var_1239 == null)
         {
            ...
            var_1239 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1507 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1507 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_412 = new Timer(1000);
         this.var_412.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1396;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_412.stop();
            this.var_412.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_412 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1396);
         }
         if(param1.length != this.var_1144.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1144.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2475 = this.canChangeOutfit();
            this.var_412.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_490 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_490.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_490.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1144.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_490.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_490.numSelectables)
               {
                  this.var_490.getSelectableAt(_loc6_).x = this.var_490.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1396;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_42) && (this.var_1762 == AvatarEditorSideCategory.const_105 || this.var_2476))
         {
      ...
      {
         if(this.var_1762 == AvatarEditorSideCategory.const_105)
         {
            this.var_2476 = false;
            this.setSideContent(AvatarEditorSideCategory.const_878);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_878:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_349 = param1;
         this.var_490.setSelected(this.var_490.getSelectableByName(param1));
