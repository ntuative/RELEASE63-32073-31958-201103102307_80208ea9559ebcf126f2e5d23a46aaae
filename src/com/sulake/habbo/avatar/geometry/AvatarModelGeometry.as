package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1199:Matrix4x4;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         super();
         this.var_1199 = new Matrix4x4();
         this.var_769 = new Dictionary();
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_769[String(_loc6_.@id)] = _loc7_;
            this.var_1870[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      {
         return this.var_769[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_769[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_769[param1] as Dictionary;
         }
      ...
      public function method_6(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1870[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1199 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1199);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1199 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1199,this.var_960,param4);
         }
         return [];
      }
