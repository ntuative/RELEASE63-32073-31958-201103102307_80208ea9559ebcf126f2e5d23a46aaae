package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_2685:ImageData;
      
      private var var_902:PaletteMap;
      
      private var var_974:Array;
      
      private var var_972:Point;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_785 == GeometryType.const_1191 && param1 == GeometryType.const_1196 || this.var_785 == GeometryType.const_1196 && param1 == GeometryType.const_1191)
         {
            this.var_785 = param1;
            this.var_88 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_375.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_693)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_466)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1272.method_10(),_loc5_,this.var_785,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_411 == null)
         {
            ...
            this.var_411 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_375);
            if(this.var_411 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_88)
         {
            this.var_88 = this._structure.getCanvas(this._scale,this.var_785);
            if(!this.var_88)
            {
               return null;
            }
            this.var_2683 = new Point(0,this.var_88.height - int(this.var_88.width / 4));
         }
         ...
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_828 || _loc10_ == AvatarAction.const_347;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1467 = this.var_119.bodyPartId;
               this.var_184 = this.var_119.partType;
               this.var_1891 = this.var_119.partId;
               ...
               this.var_1468 = this._scale + "_" + this.var_119.action.assetPartDefinition + "_" + this.var_184 + "_" + this.var_1891 + "_" + _loc5_ + "_" + this._frame;
               this.var_433 = this._assets.getAssetByName(this.var_1468) as BitmapDataAsset;
               if(this.var_433 == null)
               {
                  this.var_1468 = this._scale + "_std_" + this.var_184 + "_" + this.var_1891 + "_" + _loc5_ + "_0";
                  this.var_433 = this._assets.getAssetByName(this.var_1468) as BitmapDataAsset;
               }
               if(!(!this.var_433 || !this.var_433.content))
               {
                  ...
                  {
                     this.var_902 = this._structure.renderManager.paletteManager.getPalette(this.var_119.paletteMapId);
                     if(this.var_902 != null)
                     {
                        this.var_973 = this.var_433.content as BitmapData;
                        this.var_183 = new BitmapData(this.var_973.width,this.var_973.height);
                        this.var_2684 = this.var_902.colorize(this.var_973.getPixels(this.var_973.rect));
                        this.var_183.setPixels(this.var_183.rect,this.var_2684);
                     }
                     else
                     {
                        this.var_183 = (this.var_433.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1467 == AvatarBodyPartType.const_220 || this.var_1467 == AvatarBodyPartType.const_1500 || this.var_1467 == AvatarBodyPartType.const_1452) && this.var_119.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_183.colorTransform(this.var_183.rect,this.var_119.blendTransform);
                  }
                  this.var_972 = this.var_433.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_57)
                     {
                  ...
                  this.var_2685 = new ImageData(this.var_183,this.var_972,_loc7_);
                  this.var_974.push(this.var_2685);
               }
            }
            _loc8_--;
         }
