package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      private var var_2715:IStructureData;
      
      private var var_1914:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            this.var_1914 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         this.var_2715.appendXML(this.var_1914);
