package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2188 = parseInt(param1.@paletteid);
         this.var_562 = new Dictionary();
         this.var_562["F"] = new Dictionary();
         this.var_562["M"] = new Dictionary();
         this.var_562["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_562["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_562["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_562["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      {
         return this.var_562[param1.toUpperCase()][Math.min(param2,1)];
      }
