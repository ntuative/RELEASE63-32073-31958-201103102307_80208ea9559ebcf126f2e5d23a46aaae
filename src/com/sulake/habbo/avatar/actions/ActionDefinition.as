package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2451 = parseInt(param1.@precedence);
         this.var_2448 = String(param1.@activepartset);
         this.var_2449 = String(param1.@assetpartdefinition);
         this.var_2447 = String(param1.@lay);
         this.var_785 = String(param1.@geometrytype);
         this.var_2432 = Boolean(parseInt(param1.@main));
         this.var_2450 = Boolean(parseInt(param1.@HabboRoomWidgetLib_pet_view));
         this.var_2446 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "HabboRoomWidgetLib_pet_view")
            {
               this.var_2452 = _loc6_;
            }
            else
            {
               this.var_1741[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_737.add(param1,new Map());
         }
         var _loc4_:Map = this.var_737.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_737.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1741[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2452;
         }
         return _loc2_;
      }
