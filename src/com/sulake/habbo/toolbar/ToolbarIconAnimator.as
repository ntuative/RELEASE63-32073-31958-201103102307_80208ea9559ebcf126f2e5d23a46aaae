package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      {
         if(this.var_1451 == true || this.var_957 == 0)
         {
            if(this.var_958.length > 0)
            {
               ++this._frame;
      ...
      {
         return this.var_1451 == false && this.var_957 == 1 && this.var_1663 != this._state;
      }
