package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return this.var_1356.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2339.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_718.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      public function get size() : Number
      {
         ...
         {
            if(this.var_302[_loc2_].exists)
            {
               _loc1_ += this.var_1358;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1357.length)
         {
            _loc2_ = this.var_718.indexOf(this.var_1357[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_302[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1056 + _loc3_);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_302[this.var_718.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,this._connection,param1,this._events,this.var_585);
         this.var_40.addChild(_loc2_.window);
         this.var_718.push(param1);
         this.var_302.push(_loc2_);
         return _loc2_;
      }
   }
}
