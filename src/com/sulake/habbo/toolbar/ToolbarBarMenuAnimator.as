package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1348:Number = 25;
      
      private static const const_1344:Number = 90;
      
      private static const const_982:int = 50;
      
      private static const const_1374:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1484:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_794 = new Timer(const_1348);
         this.var_794.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         return param1.x + param1.width < const_982 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_982 || param1.desktop.height - param1.y < const_1374;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1484.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1484.getIconLoc(param1.iconId);
      ...
      {
         return this.var_646[this.var_647.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_647[this.var_646.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_647.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_647.splice(_loc3_,1);
            this.var_646.splice(_loc3_,1);
         }
         this.var_646.push(param1.name);
         this.var_647.push(param2);
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_646[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_647[_loc2_];
               if(this.var_645[_loc3_] != null)
               {
                  _loc4_ = 0;
