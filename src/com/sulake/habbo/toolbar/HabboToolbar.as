package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1341:LogoutController;
      ...
      {
         this.var_17 = new ToolbarView(this._windowManager,this._assetLibrary,this.var_308.getHabboMainConnection(null),events);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "true")
         {
            this.var_1341 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this.var_17 == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1212,this.onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_438,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1066,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1036,this.onHideWindowEvent);
         this._state = true;
      ...
      private function onSetToolbarIconEvent(param1:HabboToolbarSetIconEvent) : void
      {
         ...
         if(this.var_17 != null && this._state)
         {
            if(param1.assetName != null)
            {
               ...
               this.var_17.method_7(param1.iconId,_loc2_);
            }
            else
            {
