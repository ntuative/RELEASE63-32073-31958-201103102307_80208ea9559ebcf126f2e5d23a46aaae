package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1689:String = "badge_bg_001_png";
      
      private const const_1975:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this.var_2028 = this.var_79.getBadgeName(this.var_282);
         this.var_2033 = this.var_79.getBadgeDesc(this.var_282);
         this.var_2030 = this.var_79.getAchievementNameForFacebook(this.var_282,this.var_309.userName,this.var_309.realName,this.var_1263);
         this.var_2032 = this.var_79.getAchievementDescForFacebook(this.var_282,this.var_309.userName,this.var_309.realName,this.var_1263);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2029 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_79.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1938.toString());
         this.var_79.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1264.toString());
         this.var_79.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1264.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1516;
         var _loc17_:String = this.var_1516 == 0 ? "pixels" : "activitypoints";
         this.var_79.registerParameter(_loc16_,_loc17_,"" + this.var_2031);
         _loc15_.caption = this.var_79.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1689);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1975) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_79.registerParameter(param1,"badge_name",this.var_2028);
         this.var_79.registerParameter(param1,"badge_desc",this.var_2033);
         this.var_79.registerParameter(param1,"badge_name_fb",this.var_2030);
         this.var_79.registerParameter(param1,"badge_desc_fb",this.var_2032);
         this.var_79.registerParameter(param1,"level",this.var_1263.toString());
         this.var_79.registerParameter(param1,"name",this.var_309.userName);
         return this.var_79.registerParameter(param1,"realname",this.var_309.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_309.events.removeEventListener(BadgeImageReadyEvent.const_153,this.onBadgeImageReady);
            this.var_309 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1689);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_282,this._feedTitleFb,this.var_2029,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2034));
