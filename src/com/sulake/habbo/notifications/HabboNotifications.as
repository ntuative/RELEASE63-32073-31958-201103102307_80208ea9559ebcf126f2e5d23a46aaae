package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1314:String = "inventory";
      
      private static const const_1318:String = "selectfurni";
      
      private static const const_1313:String = "credits";
      
      private static const const_1312:String = "friendlist";
      
      private static const const_1316:String = "pet_inventory";
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         this.var_1147.push(_loc8_);
         return this.var_1147.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1147.splice(0,1);
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_745.events.addEventListener(HabboToolbarEvent.const_68,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_68)
         {
            ...
            this.var_492 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_912["styles"],this.var_912["view"],this.var_745);
            ...
            this.var_309.events.addEventListener(BadgeImageReadyEvent.const_153,this.onBadgeImage);
            this.var_745.events.addEventListener(HabboToolbarEvent.const_544,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1400[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_309);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1383,null);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_309.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1016,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1016,null);
            }
         }
      }
      ...
      private function onBadgeReceived(param1:BadgeReceivedMessageEvent) : void
      {
         ...
         if(this.var_309.userId == _loc3_)
         {
            ...
            _loc9_ = this.var_309.getBadgeImage(_loc4_);
            this.addItem(!!_loc6_ ? _loc6_.value : "notifications.text.received.badge",NotificationType.const_655,_loc9_,_loc4_);
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1401,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_506.createAvatarImage(param2,AvatarScaleType.const_57);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_309.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_85)
               {
                  _loc9_ = this.var_309.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_309.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1529,_loc5_);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_85:
               ...
               break;
            case CatalogPageMessageProductData.const_271:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1520,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1530)
         {
      ...
      {
         var _loc2_:* = null;
         if(this.var_492.isSpaceAvailable() && this.var_1147.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_492.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_506.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_57);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2489)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_655,null);
            this.var_2489 = true;
      ...
      {
         if(param2.type == WindowEvent.const_183 || param2.type == WindowEvent.const_842)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_655,_loc6_);
      }
   }
}
