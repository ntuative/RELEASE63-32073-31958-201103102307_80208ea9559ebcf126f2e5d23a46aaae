package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_788:int = 70;
      ...
      private static const const_930:int = 2;
      
      private static const const_931:int = 3;
      
      private static const const_411:Number = 50;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1651 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1651 = 15;
         }
         this.var_1650 = this._window.height;
         this.var_708 = 4;
         this.var_707 = 0;
         this._state = name_2;
         this.var_174 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_450:
               ...
               _loc2_ = Number(this.var_1078) / Number(this.var_402["time_fade_in"]);
               if(this.var_1078 > int(this.var_402["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_930:
               ...
               if(this.var_1334 > int(this.var_402["time_display"]) && !this.var_1649)
               {
                  this.startFadeOut();
               }
               break;
            case const_931:
               ...
               _loc3_ = 1 - Number(this.var_1079) / Number(this.var_402["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1079 > int(this.var_402["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1651;
         if(this._window.height < this.var_1650)
         {
            this._window.height = this.var_1650;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_174.orientation == "TOP" ? int(const_411) : 0;
         var _loc4_:int = this.var_174.orientation == "BOTTOM" ? int(_loc2_.height - const_411) : int(_loc2_.height);
         var _loc5_:int = this.var_174.orientation == "LEFT" ? int(const_411) : 0;
         var _loc6_:int = this.var_174.orientation == "RIGHT" ? int(_loc2_.width - const_411) : int(_loc2_.width);
         if(this.var_402["position_horizontal_follow_toolbar"] == "true" && (this.var_174.orientation != "TOP" && this.var_174.orientation != "BOTTOM"))
         {
            if(this.var_174.orientation == "LEFT")
            {
         ...
         else if(this.var_402["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_505;
         }
         else
         ...
         if(this.var_402["position_vertical_follow_toolbar"] == "true" && (this.var_174.orientation != "RIGHT" && this.var_174.orientation != "LEFT"))
         {
            if(this.var_174.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_708;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_708;
            }
         }
         else if(this.var_402["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_708;
         }
         else
