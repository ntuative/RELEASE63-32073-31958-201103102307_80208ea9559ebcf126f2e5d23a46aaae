package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private var var_1262:HabboTracking;
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1262 = HabboTracking.getInstance();
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1262 && !this.var_1262.disposed)
                  {
                     this.var_1262.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
